...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %args) {
  ...
  %_args7980 = alloca { i64, [0 x i8*] }*
  store i64 %argc, i64* %_argc7978
  store { i64, [0 x i8*] }* %args, { i64, [0 x i8*] }** %_args7980
...
define { i64, [0 x i64] }* @function(i64 %x) {
  ...
  %_load7961 = load i64, i64* %_x7956
  %_bop7962 = icmp eq i64 %_load7961, 0
  br i1 %_bop7962, label %_then7958, label %_else7959
_then7958:
  ret { i64, [0 x i64] }* null
_else7959:
  %_load7966 = load i64, i64* %_x7956
  %_bop7967 = icmp eq i64 %_load7966, 1
