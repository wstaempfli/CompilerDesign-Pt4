...
_join5798:
  ...
  %_5816 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_a_chars5814, i32 0, i32 1, i64 %_i5815
  %_5817 = load i64, i64* %_5816
  store i64 %_5817, i64* %_last_char_a5818
  %_b_chars5820 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_b_chars5812
  %_j5821 = load i64, i64* %_j5789
  %_5822 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_b_chars5820, i32 0, i32 1, i64 %_j5821
  %_5823 = load i64, i64* %_5822
  store i64 %_5823, i64* %_last_char_b5824
...
_then5826:
  ...
  %_5843 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_a_chars5841, i32 0, i32 1, i64 %_i5842
  %_5844 = load i64, i64* %_5843
  %_buf5845 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** @buf
  %_gep5846 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_buf5845, i32 0, i32 1, i32 0
  store i64 %_5844, i64* %_gep5846
