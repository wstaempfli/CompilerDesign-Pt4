...
define i64 @f({ i64, [0 x i64] }* %a) {
  ...
  %_elem_addr1601 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_a1600, i32 0, i32 1, i32 1
  %_read_val1602 = load i64, i64* %_elem_addr1601
  ret i64 %_read_val1602
}
...
_for_exit1584:
  ...
  %_elem_addr1596 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_arr1595, i32 0, i32 1, i32 1
  %_read_val1597 = load i64, i64* %_elem_addr1596
  ret i64 %_read_val1597
}
...
_for_exit1550:
  ...
  %_elem_addr1563 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_arr1562, i32 0, i32 1, i32 3
  %_read_val1564 = load i64, i64* %_elem_addr1563
  %_a1565 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_a1504
  %_elem_addr1566 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_a1565, i32 0, i32 1, i32 1
  %_read_val1567 = load i64, i64* %_elem_addr1566
  %_bop1568 = add i64 %_read_val1564, %_read_val1567
  %_arr01569 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_arr01544
  %_funcall1570 = call i64 @f({ i64, [0 x i64] }* %_arr01569)
  %_bop1571 = add i64 %_bop1568, %_funcall1570
  %_funcall1572 = call i64 @g(i64 4)
  %_bop1573 = add i64 %_bop1571, %_funcall1572
  ret i64 %_bop1573
}
