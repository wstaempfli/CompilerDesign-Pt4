...
define void @matrix_Mult({ i64, [0 x { i64, [0 x i64] }*] }* %a1, { i64, [0 x { i64, [0 x i64] }*] }* %a2, { i64, [0 x { i64, [0 x i64] }*] }* %a3) {
  ...
  br label %_while_cond4048
_while_cond4048:
  %_i4051 = load i64, i64* %_i4046
  %_bop4052 = icmp slt i64 %_i4051, 2
  br i1 %_bop4052, label %_while_body4049, label %_while_end4050
_while_body4049:
  store i64 0, i64* %_j4053
  br label %_while_cond4055
_while_cond4055:
  %_j4058 = load i64, i64* %_j4053
  %_bop4059 = icmp slt i64 %_j4058, 4
  br i1 %_bop4059, label %_while_body4056, label %_while_end4057
_while_body4056:
  store i64 0, i64* %_k4060
  br label %_while_cond4062
_while_cond4062:
  %_k4065 = load i64, i64* %_k4060
  %_bop4066 = icmp slt i64 %_k4065, 3
  br i1 %_bop4066, label %_while_body4063, label %_while_end4064
_while_body4063:
  store i64 %_bop4089, i64* %_elem_ptr4095
  %_elem_ptr4095 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_load4093, i32 0, i32 1, i64 %_j4094
...
define void @matrix_MultAlt({ i64, [0 x { i64, [0 x i64] }*] }* %a1, { i64, [0 x { i64, [0 x i64] }*] }* %a2, { i64, [0 x { i64, [0 x i64] }*] }* %a3) {
  ...
  br label %_while_cond4010
_while_cond4010:
  %_i4013 = load i64, i64* %_i4008
  %_bop4014 = icmp slt i64 %_i4013, 2
  br i1 %_bop4014, label %_while_body4011, label %_while_end4012
_while_body4011:
  store i64 0, i64* %_j4015
  br label %_while_cond4017
_while_cond4017:
  %_j4020 = load i64, i64* %_j4015
  %_bop4021 = icmp slt i64 %_j4020, 4
  br i1 %_bop4021, label %_while_body4018, label %_while_end4019
_while_body4018:
  store i64 %_call4026, i64* %_elem_ptr4032
  %_elem_ptr4032 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_load4030, i32 0, i32 1, i64 %_j4031
...
define i64 @dot3({ i64, [0 x { i64, [0 x i64] }*] }* %a1, { i64, [0 x { i64, [0 x i64] }*] }* %a2, i64 %row, i64 %col) {
  ...
  br label %_while_cond3975
_while_cond3975:
  %_k3978 = load i64, i64* %_k3973
  %_bop3979 = icmp slt i64 %_k3978, 3
  br i1 %_bop3979, label %_while_body3976, label %_while_end3977
_while_body3976:
