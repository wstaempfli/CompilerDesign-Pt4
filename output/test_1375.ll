...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  %_function435 = call { i64, [0 x i64] }* @f({ i64, [0 x i64] }* %_x433, { i64, [0 x i64] }* %_y434, i1 1)
  %_gep436 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_function435, i32 0, i32 1, i32 0
  store i64 17, i64* %_gep436
  %_y439 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** @y
  %_x438 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** @x
  %_function440 = call { i64, [0 x i64] }* @f({ i64, [0 x i64] }* %_x438, { i64, [0 x i64] }* %_y439, i1 1)
  %_gep441 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_function440, i32 0, i32 1, i32 0
  %_load442 = load i64, i64* %_gep441
  %_x444 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** @x
  %_y443 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** @y
  %_function445 = call { i64, [0 x i64] }* @f({ i64, [0 x i64] }* %_y443, { i64, [0 x i64] }* %_x444, i1 0)
  %_gep446 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_function445, i32 0, i32 1, i32 0
