...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  %_argv6340 = alloca { i64, [0 x i8*] }*
  %_x6350 = alloca { i64, [0 x i64] }*
  %_z6354 = alloca i8*
  store i64 %argc, i64* %_argc6338
  store { i64, [0 x i8*] }* %argv, { i64, [0 x i8*] }** %_argv6340
  ...
  %_load6352 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_x6350
  %_call6353 = call i8* @string_of_array({ i64, [0 x i64] }* %_load6352)
  store i8* %_call6353, i8** %_z6354
  %_load6356 = load i8*, i8** %_z6354
  call void @print_string(i8* %_load6356)
  ret i64 0
}
