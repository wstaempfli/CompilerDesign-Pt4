...
_while_cond314:
  ...
  br i1 %_bop318, label %_while_body315, label %_while_end316
_while_body315:
  store i64 %_i319, i64* %_elem_ptr322
  %_elem_ptr322 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_x320, i32 0, i32 1, i64 %_i321
...
_while_end316:
  ...
  br label %_while_cond333
_while_cond333:
  %_i336 = load i64, i64* %_i331
  %_bop337 = icmp slt i64 %_i336, 3
  br i1 %_bop337, label %_while_body334, label %_while_end335
_while_body334:
  store i64 %_bop339, i64* %_elem_ptr342
  %_elem_ptr342 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_y340, i32 0, i32 1, i64 %_i341
  ...
  br label %_while_end335
_while_end335:
  store i64 17, i64* %_elem_ptr350
  %_elem_ptr350 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_call349, i32 0, i32 1, i32 0
  ...
  %_gep353 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_x352, i32 0, i32 1, i32 0
