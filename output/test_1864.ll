...
_for_body3051:
  ...
  %_3060 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_arr3056, i32 0, i32 1, i64 %_bop3059
  %_3061 = load i64, i64* %_3060
...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  %_3029 = getelementptr { i64, [0 x i8*] }, { i64, [0 x i8*] }* %_argv3028, i32 0, i32 1, i32 1
  %_3030 = load i8*, i8** %_3029
  %_funcall3031 = call i8* @sub(i8* %_3030, i64 3, i64 5)
