...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  %_load2045 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_a2043
  %_call2046 = call i8* @string_of_array({ i64, [0 x i64] }* %_load2045)
  store i8* %_call2046, i8** %_str2047
  %_load2049 = load i8*, i8** %_str2047
  call void @print_string(i8* %_load2049)
  ret i64 0
}
