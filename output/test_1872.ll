...
_join4271:
  ...
  %_4286 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_input4284, i32 0, i32 1, i64 %_midpt4285
  %_4287 = load i64, i64* %_4286
  %_key4288 = load i64, i64* %_key4262
  %_bop4289 = icmp sgt i64 %_4287, %_key4288
...
_join4283:
  ...
  %_4301 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_input4299, i32 0, i32 1, i64 %_midpt4300
  %_4302 = load i64, i64* %_4301
  %_key4303 = load i64, i64* %_key4262
  %_bop4304 = icmp slt i64 %_4302, %_key4303
...
_then4247:
  %_str4259 = bitcast [9 x i8]* @_str4258 to i8*
  call void @print_string(i8* %_str4259)
  br label %_join4249
_else4248:
  br label %_join4249
_join4249:
