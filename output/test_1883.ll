...
_then5745:
  ...
  %_5764 = getelementptr { i64, [0 x { i64, [0 x i64] }*] }, { i64, [0 x { i64, [0 x i64] }*] }* %_board5762, i32 0, i32 1, i64 %_i5763
  %_5765 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_5764
  %_j5766 = load i64, i64* %_j5739
  %_5767 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_5765, i32 0, i32 1, i64 %_j5766
  %_5768 = load i64, i64* %_5767
  %_bop5769 = add i64 %_count5761, %_5768
  ret i64 %_bop5769
_else5746:
...
define i64 @val_at({ i64, [0 x { i64, [0 x i64] }*] }* %board, i64 %i, i64 %j) {
  ...
  %_5648 = getelementptr { i64, [0 x { i64, [0 x i64] }*] }, { i64, [0 x { i64, [0 x i64] }*] }* %_board5646, i32 0, i32 1, i64 %_i5647
  %_5649 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_5648
  %_j5650 = load i64, i64* %_j5642
  %_5651 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_5649, i32 0, i32 1, i64 %_j5650
  %_5652 = load i64, i64* %_5651
  store i64 %_5652, i64* %_alive5653
...
_for_body5589:
  ...
  %_5599 = getelementptr { i64, [0 x { i64, [0 x i64] }*] }, { i64, [0 x { i64, [0 x i64] }*] }* %_new_board5597, i32 0, i32 1, i64 %_i5598
  %_5600 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_5599
  %_j5601 = load i64, i64* %_j5586
  %_gep5602 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_5600, i32 0, i32 1, i64 %_j5601
...
_for_body5621:
  ...
  %_5628 = getelementptr { i64, [0 x { i64, [0 x i64] }*] }, { i64, [0 x { i64, [0 x i64] }*] }* %_new_board5626, i32 0, i32 1, i64 %_i5627
  %_5629 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_5628
  %_j5630 = load i64, i64* %_j5618
  %_5631 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_5629, i32 0, i32 1, i64 %_j5630
  %_5632 = load i64, i64* %_5631
  call void @print_int(i64 %_5632)
