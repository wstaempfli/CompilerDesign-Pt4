...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  %_argv7765 = alloca { i64, [0 x i8*] }*
  %_x7781 = alloca { i64, [0 x { i64, [0 x i64] }*] }*
  store i64 %argc, i64* %_argc7763
  store { i64, [0 x i8*] }* %argv, { i64, [0 x i8*] }** %_argv7765
  ...
  %_load7783 = load { i64, [0 x { i64, [0 x i64] }*] }*, { i64, [0 x { i64, [0 x i64] }*] }** %_x7781
  store { i64, [0 x { i64, [0 x i64] }*] }* %_load7783, { i64, [0 x { i64, [0 x i64] }*] }** @arr
  %_load7785 = load { i64, [0 x { i64, [0 x i64] }*] }*, { i64, [0 x { i64, [0 x i64] }*] }** %_x7781
  %_gep7786 = getelementptr { i64, [0 x { i64, [0 x i64] }*] }, { i64, [0 x { i64, [0 x i64] }*] }* %_load7785, i32 0, i32 1, i32 2
  ...
  %_load7790 = load { i64, [0 x { i64, [0 x i64] }*] }*, { i64, [0 x { i64, [0 x i64] }*] }** @arr
  %_gep7791 = getelementptr { i64, [0 x { i64, [0 x i64] }*] }, { i64, [0 x { i64, [0 x i64] }*] }* %_load7790, i32 0, i32 1, i32 2
