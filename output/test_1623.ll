...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  %_elem_addr1368 = getelementptr { i64, [0 x { i64, [0 x i64] }*] }, { i64, [0 x { i64, [0 x i64] }*] }* %_garr1367, i32 0, i32 1, i32 1
  %_read_val1369 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_elem_addr1368
  %_funcall1370 = call { i64, [0 x i64] }* @f({ i64, [0 x i64] }* %_read_val1369)
  store { i64, [0 x i64] }* %_funcall1370, { i64, [0 x i64] }** %_arr1371
  %_arr1373 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_arr1371
  %_elem_addr1374 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_arr1373, i32 0, i32 1, i32 1
  %_read_val1375 = load i64, i64* %_elem_addr1374
  ret i64 %_read_val1375
}
