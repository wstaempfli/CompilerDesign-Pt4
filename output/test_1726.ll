...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  %_elem_addr1227 = getelementptr { i64, [0 x { i64, [0 x i64] }*] }, { i64, [0 x { i64, [0 x i64] }*] }* %_arr1226, i32 0, i32 1, i32 0
  %_read_val1228 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_elem_addr1227
  %_elem_addr1229 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_read_val1228, i32 0, i32 1, i32 0
  %_read_val1230 = load i64, i64* %_elem_addr1229
  ret i64 %_read_val1230
}
