...
define i64 @g({ i64, [0 x i64] }* %y) {
  ...
  %_1106 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_y1105, i32 0, i32 1, i32 2
  %_1107 = load i64, i64* %_1106
  ret i64 %_1107
}
...
_for_exit1074:
  ...
  %_1089 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_arr1088, i32 0, i32 1, i32 3
  %_1090 = load i64, i64* %_1089
  %_funcall1091 = call i64 @f(i64 %_1090)
  %_bop1092 = add i64 %_bop1087, %_funcall1091
  %_garr1093 = load { i64, [0 x { i64, [0 x i64] }*] }*, { i64, [0 x { i64, [0 x i64] }*] }** %_garr1054
  %_1094 = getelementptr { i64, [0 x { i64, [0 x i64] }*] }, { i64, [0 x { i64, [0 x i64] }*] }* %_garr1093, i32 0, i32 1, i32 1
  %_1095 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_1094
  %_1096 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_1095, i32 0, i32 1, i32 1
  %_1097 = load i64, i64* %_1096
  %_funcall1098 = call i64 @f(i64 %_1097)
