...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  %_argv1967 = alloca { i64, [0 x i8*] }*
  %_strs1979 = alloca { i64, [0 x i8*] }*
  store i64 %argc, i64* %_argc1965
  store { i64, [0 x i8*] }* %argv, { i64, [0 x i8*] }** %_argv1967
  ...
  %_load1981 = load { i64, [0 x i8*] }*, { i64, [0 x i8*] }** %_strs1979
  %_gep1982 = getelementptr { i64, [0 x i8*] }, { i64, [0 x i8*] }* %_load1981, i32 0, i32 1, i32 0
  %_load1983 = load i8*, i8** %_gep1982
