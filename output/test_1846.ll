...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  %_2018 = getelementptr { i64, [0 x { i64, [0 x i8*] }*] }, { i64, [0 x { i64, [0 x i8*] }*] }* %_strs2017, i32 0, i32 1, i32 1
  %_2019 = load { i64, [0 x i8*] }*, { i64, [0 x i8*] }** %_2018
  %_2020 = getelementptr { i64, [0 x i8*] }, { i64, [0 x i8*] }* %_2019, i32 0, i32 1, i32 1
  %_2021 = load i8*, i8** %_2020
  call void @print_string(i8* %_2021)
  ret i64 0
}
