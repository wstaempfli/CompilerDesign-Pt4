...
define { i64, [0 x i64] }* @count_sort({ i64, [0 x i64] }* %arr, i64 %len) {
  ...
  %_function4605 = call i64 @min({ i64, [0 x i64] }* %_arr4603, i64 %_len4604)
  store i64 %_function4605, i64* %_min4606
  %_len4609 = load i64, i64* %_len4600
  %_arr4608 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_arr4599
  %_function4610 = call i64 @max({ i64, [0 x i64] }* %_arr4608, i64 %_len4609)
  store i64 %_function4610, i64* %_max4611
...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  %_function4586 = call i8* @string_of_array({ i64, [0 x i64] }* %_arr4585)
  call void @print_string(i8* %_function4586)
  ...
  %_function4593 = call { i64, [0 x i64] }* @count_sort({ i64, [0 x i64] }* %_arr4591, i64 %_len4592)
  store { i64, [0 x i64] }* %_function4593, { i64, [0 x i64] }** %_sorted4594
  %_sorted4596 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_sorted4594
  %_function4597 = call i8* @string_of_array({ i64, [0 x i64] }* %_sorted4596)
  call void @print_string(i8* %_function4597)
  ret i64 0
}
