...
_for_body2935:
  ...
  %_elem_addr2942 = getelementptr { i64, [0 x i8*] }, { i64, [0 x i8*] }* %_argv2940, i32 0, i32 1, i64 %_i2941
  %_read_val2943 = load i8*, i8** %_elem_addr2942
  call void @print_string(i8* %_read_val2943)
