...
_for_exit1074:
  ...
  %_function1084 = call i64 @g({ i64, [0 x i64] }* %_arr1083)
  %_i1085 = load i64, i64* @i
  %_function1086 = call i64 @f(i64 %_i1085)
  %_bop1087 = add i64 %_function1084, %_function1086
  ...
  %_function1091 = call i64 @f(i64 %_load1090)
  %_bop1092 = add i64 %_bop1087, %_function1091
  ...
  %_function1098 = call i64 @f(i64 %_load1097)
  %_bop1099 = add i64 %_bop1092, %_function1098
  %_p1100 = load i64, i64* %_p1068
  %_function1101 = call i64 @f(i64 %_p1100)
  %_bop1102 = add i64 %_bop1099, %_function1101
  ret i64 %_bop1102
}
