...
_for_body2809:
  ...
  %_elem_addr2816 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_arr2814, i32 0, i32 1, i64 %_i2815
  %_read_val2817 = load i64, i64* %_elem_addr2816
  %_bop2818 = add i64 %_s2813, %_read_val2817
