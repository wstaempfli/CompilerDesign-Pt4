...
_then3246:
  ...
  %_funcall3255 = call i64 @partition({ i64, [0 x i64] }* %_a3252, i64 %_l3253, i64 %_r3254)
  store i64 %_funcall3255, i64* %_j3244
...
define i64 @partition({ i64, [0 x i64] }* %a, i64 %l, i64 %r) {
  ...
  %_elem_addr3135 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_a3133, i32 0, i32 1, i64 %_l3134
  %_read_val3136 = load i64, i64* %_elem_addr3135
  store i64 %_read_val3136, i64* %_pivot3137
...
_while_cond3158:
  ...
  %_elem_addr3163 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_a3161, i32 0, i32 1, i64 %_i3162
  %_read_val3164 = load i64, i64* %_elem_addr3163
  %_pivot3165 = load i64, i64* %_pivot3137
  %_bop3166 = icmp sle i64 %_read_val3164, %_pivot3165
...
_while_cond3177:
  ...
  %_elem_addr3182 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_a3180, i32 0, i32 1, i64 %_j3181
  %_read_val3183 = load i64, i64* %_elem_addr3182
  %_pivot3184 = load i64, i64* %_pivot3137
  %_bop3185 = icmp sgt i64 %_read_val3183, %_pivot3184
...
_then3196:
  ...
  %_elem_addr3203 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_a3201, i32 0, i32 1, i64 %_i3202
  %_read_val3204 = load i64, i64* %_elem_addr3203
  store i64 %_read_val3204, i64* %_t3146
  %_a3206 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_a3127
  %_j3207 = load i64, i64* %_j3144
  %_elem_addr3208 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_a3206, i32 0, i32 1, i64 %_j3207
  %_read_val3209 = load i64, i64* %_elem_addr3208
  ...
  store i64 %_read_val3209, i64* %_gep3212
...
_while_exit3152:
  ...
  %_elem_addr3221 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_a3219, i32 0, i32 1, i64 %_l3220
  %_read_val3222 = load i64, i64* %_elem_addr3221
  store i64 %_read_val3222, i64* %_t3146
  %_a3224 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_a3127
  %_j3225 = load i64, i64* %_j3144
  %_elem_addr3226 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_a3224, i32 0, i32 1, i64 %_j3225
  %_read_val3227 = load i64, i64* %_elem_addr3226
  ...
  store i64 %_read_val3227, i64* %_gep3230
...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  %_funcall3120 = call i8* @string_of_array({ i64, [0 x i64] }* %_a3119)
  call void @print_string(i8* %_funcall3120)
  ...
  %_funcall3125 = call i8* @string_of_array({ i64, [0 x i64] }* %_a3124)
  call void @print_string(i8* %_funcall3125)
  ret i64 255
}
