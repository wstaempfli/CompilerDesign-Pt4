...
_then4968:
  ...
  %_gep4979 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_array4977, i32 0, i32 1, i64 %_l4978
  %_load4980 = load i64, i64* %_gep4979
  %_array4981 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_array4949
  %_m4982 = load i64, i64* %_m4966
  %_gep4983 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_array4981, i32 0, i32 1, i64 %_m4982
...
_then4988:
  ...
  %_gep4999 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_array4997, i32 0, i32 1, i64 %_r4998
  %_load5000 = load i64, i64* %_gep4999
  %_array5001 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_array4949
  %_m5002 = load i64, i64* %_m4966
  %_gep5003 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_array5001, i32 0, i32 1, i64 %_m5002
...
_then5008:
  ...
  %_gep5016 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_array5014, i32 0, i32 1, i64 %_i5015
  %_load5017 = load i64, i64* %_gep5016
  store i64 %_load5017, i64* %_tmp4963
  store i64 %_load5022, i64* %_elem_ptr5025
  %_elem_ptr5025 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_array5023, i32 0, i32 1, i64 %_i5024
  %_array5019 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_array4949
  %_m5020 = load i64, i64* %_m4966
  %_gep5021 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_array5019, i32 0, i32 1, i64 %_m5020
  %_load5022 = load i64, i64* %_gep5021
  %_i5024 = load i64, i64* %_i4950
  %_array5023 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_array4949
  store i64 %_tmp5027, i64* %_elem_ptr5030
  %_elem_ptr5030 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_array5028, i32 0, i32 1, i64 %_m5029
...
define void @make_min_heap({ i64, [0 x i64] }* %array, i64 %len) {
  ...
  br label %_while_cond4937
_while_cond4937:
  %_i4940 = load i64, i64* %_i4935
  %_bop4941 = icmp sge i64 %_i4940, 1
  br i1 %_bop4941, label %_while_body4938, label %_while_end4939
_while_body4938:
