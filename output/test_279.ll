...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  %_load2733 = load i64, i64* %_gep_ptr2732
  %_gep_ptr2732 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_b2731, i32 0, i32 1, i32 0
  %_bop2734 = add i64 %_a2730, %_load2733
  %_b2735 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_b2720
  %_load2737 = load i64, i64* %_gep_ptr2736
  %_gep_ptr2736 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_b2735, i32 0, i32 1, i32 1
