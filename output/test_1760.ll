...
_for_body3329:
  ...
  %_elem_addr3340 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_numbers3337, i32 0, i32 1, i64 %_bop3339
  %_read_val3341 = load i64, i64* %_elem_addr3340
  %_numbers3342 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_numbers3311
  %_i3343 = load i64, i64* %_i3319
  %_elem_addr3344 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_numbers3342, i32 0, i32 1, i64 %_i3343
  %_read_val3345 = load i64, i64* %_elem_addr3344
  %_bop3346 = icmp sgt i64 %_read_val3341, %_read_val3345
...
_then3334:
  ...
  %_elem_addr3350 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_numbers3347, i32 0, i32 1, i64 %_bop3349
  %_read_val3351 = load i64, i64* %_elem_addr3350
  store i64 %_read_val3351, i64* %_temp3315
  %_numbers3353 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_numbers3311
  %_i3354 = load i64, i64* %_i3319
  %_elem_addr3355 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_numbers3353, i32 0, i32 1, i64 %_i3354
  %_read_val3356 = load i64, i64* %_elem_addr3355
  ...
  store i64 %_read_val3356, i64* %_gep3360
...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  %_funcall3300 = call i8* @string_of_array({ i64, [0 x i64] }* %_a3299)
  call void @print_string(i8* %_funcall3300)
  %_str3303 = bitcast [2 x i8]* @_str3302 to i8*
  call void @print_string(i8* %_str3303)
  ...
  %_funcall3308 = call i8* @string_of_array({ i64, [0 x i64] }* %_a3307)
  call void @print_string(i8* %_funcall3308)
