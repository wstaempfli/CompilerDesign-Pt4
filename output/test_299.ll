...
_for_body4500:
  ...
  %_load4511 = load i1, i1* %_gep_ptr4510
  %_gep_ptr4510 = getelementptr { i64, [0 x i1] }, { i64, [0 x i1] }* %_arr4508, i32 0, i32 1, i64 %_i4509
...
_for_body4538:
  ...
  %_load4549 = load i1, i1* %_gep_ptr4548
  %_gep_ptr4548 = getelementptr { i64, [0 x i1] }, { i64, [0 x i1] }* %_arr4546, i32 0, i32 1, i64 %_i4547
