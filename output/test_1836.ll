...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  %_1335 = getelementptr { i64, [0 x { i64, [0 x i64] }*] }, { i64, [0 x { i64, [0 x i64] }*] }* %_arr1334, i32 0, i32 1, i32 1
  %_1336 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_1335
  %_1337 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_1336, i32 0, i32 1, i32 1
  %_1338 = load i64, i64* %_1337
  ret i64 %_1338
}
