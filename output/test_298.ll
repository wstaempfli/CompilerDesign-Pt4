...
define i64 @xor_shift_plus({ i64, [0 x i64] }* %s) {
  ...
  %_load4413 = load i64, i64* %_gep_ptr4412
  %_gep_ptr4412 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_s4411, i32 0, i32 1, i32 0
  store i64 %_load4413, i64* %_x4414
  %_s4416 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_s4409
  %_load4418 = load i64, i64* %_gep_ptr4417
  %_gep_ptr4417 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_s4416, i32 0, i32 1, i32 1
