...
_then3904:
  ...
  %_gep3915 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_a3913, i32 0, i32 1, i64 %_i3914
...
_while_body3849:
  ...
  %_gep3861 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_a3859, i32 0, i32 1, i64 %_i3860
  %_load3862 = load i64, i64* %_gep3861
  store i64 %_load3862, i64* %_t3842
  store i64 %_load3867, i64* %_elem_ptr3870
  %_elem_ptr3870 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_a3868, i32 0, i32 1, i64 %_i3869
  %_a3864 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_a3838
  %_mi3865 = load i64, i64* %_mi3844
  %_gep3866 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_a3864, i32 0, i32 1, i64 %_mi3865
  %_load3867 = load i64, i64* %_gep3866
  %_i3869 = load i64, i64* %_i3846
  %_a3868 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_a3838
  store i64 %_t3872, i64* %_elem_ptr3875
  %_elem_ptr3875 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_a3873, i32 0, i32 1, i64 %_mi3874
...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  br label %_while_cond3825
_while_cond3825:
  %_i3828 = load i64, i64* %_i3823
  %_bop3829 = icmp slt i64 %_i3828, 8
  br i1 %_bop3829, label %_while_body3826, label %_while_end3827
_while_body3826:
  %_ar3830 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_ar3819
  %_i3831 = load i64, i64* %_i3823
  %_gep3832 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_ar3830, i32 0, i32 1, i64 %_i3831
