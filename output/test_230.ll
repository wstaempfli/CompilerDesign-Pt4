...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  store i64 99, i64* %_gep472
  %_gep472 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_array471, i32 0, i32 1, i32 0
  store i64 0, i64* %_gep474
  %_gep474 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_array471, i32 0, i32 1, i32 1
  store { i64, [0 x i64] }* %_array471, { i64, [0 x i64] }** %_i476
  %_i478 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_i476
  %_load480 = load i64, i64* %_gep_ptr479
  %_gep_ptr479 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_i478, i32 0, i32 1, i32 0
  ret i64 %_load480
}
