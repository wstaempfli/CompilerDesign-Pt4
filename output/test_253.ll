...
define i64 @g({ i64, [0 x i64] }* %y) {
  ...
  %_load1107 = load i64, i64* %_gep_ptr1106
  %_gep_ptr1106 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_y1105, i32 0, i32 1, i32 2
  ret i64 %_load1107
}
...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  store i64 1, i64* %_gep1040
  %_gep1040 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_array1039, i32 0, i32 1, i32 0
  store i64 2, i64* %_gep1042
  %_gep1042 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_array1039, i32 0, i32 1, i32 1
  store { i64, [0 x i64] }* %_array1039, { i64, [0 x i64] }** %_gep1044
  %_gep1044 = getelementptr { i64, [0 x { i64, [0 x i64] }*] }, { i64, [0 x { i64, [0 x i64] }*] }* %_array1037, i32 0, i32 1, i32 0
  %_raw_array1046 = call i64* @oat_alloc_array(i64 2)
  %_array1047 = bitcast i64* %_raw_array1046 to { i64, [0 x i64] }*
  store i64 3, i64* %_gep1048
  %_gep1048 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_array1047, i32 0, i32 1, i32 0
  store i64 4, i64* %_gep1050
  %_gep1050 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_array1047, i32 0, i32 1, i32 1
  store { i64, [0 x i64] }* %_array1047, { i64, [0 x i64] }** %_gep1052
  %_gep1052 = getelementptr { i64, [0 x { i64, [0 x i64] }*] }, { i64, [0 x { i64, [0 x i64] }*] }* %_array1037, i32 0, i32 1, i32 1
  ...
  store i64 1, i64* %_gep1058
  %_gep1058 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_array1057, i32 0, i32 1, i32 0
  store i64 2, i64* %_gep1060
  %_gep1060 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_array1057, i32 0, i32 1, i32 1
  store i64 3, i64* %_gep1062
  %_gep1062 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_array1057, i32 0, i32 1, i32 2
  store i64 4, i64* %_gep1064
  %_gep1064 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_array1057, i32 0, i32 1, i32 3
  store { i64, [0 x i64] }* %_array1057, { i64, [0 x i64] }** %_arr1066
  store i64 0, i64* %_p1068
  store i64 0, i64* %_j1070
  br label %_for_cond1072
_for_cond1072:
  %_j1075 = load i64, i64* %_j1070
  %_bop1076 = icmp slt i64 %_j1075, 100
  br i1 %_bop1076, label %_for_body1073, label %_for_exit1074
_for_body1073:
...
_for_exit1074:
  ...
  %_load1090 = load i64, i64* %_gep_ptr1089
  %_gep_ptr1089 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_arr1088, i32 0, i32 1, i32 3
  ...
  %_load1095 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_gep_ptr1094
  %_gep_ptr1094 = getelementptr { i64, [0 x { i64, [0 x i64] }*] }, { i64, [0 x { i64, [0 x i64] }*] }* %_garr1093, i32 0, i32 1, i32 1
  %_load1097 = load i64, i64* %_gep_ptr1096
  %_gep_ptr1096 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_load1095, i32 0, i32 1, i32 1
