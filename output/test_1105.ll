...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  %_load767 = load { i64, [0 x { i64, [0 x i64] }*] }*, { i64, [0 x { i64, [0 x i64] }*] }** %_a765
  %_gep768 = getelementptr { i64, [0 x { i64, [0 x i64] }*] }, { i64, [0 x { i64, [0 x i64] }*] }* %_load767, i32 0, i32 1, i32 0
  %_load769 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_gep768
  %_gep770 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_load769, i32 0, i32 1, i32 1
  %_load771 = load i64, i64* %_gep770
  ret i64 %_load771
}
