...
_while_cond1019:
  %_load1022 = load i64, i64* %_x1015
  %_bop1023 = icmp sgt i64 %_load1022, 0
  br i1 %_bop1023, label %_while_body1020, label %_while_exit1021
_while_body1020:
  %_load1024 = load i64, i64* %_acc1017
  %_load1025 = load i64, i64* %_x1015
  %_bop1026 = mul i64 %_load1024, %_load1025
  store i64 %_bop1026, i64* %_acc1017
  %_load1028 = load i64, i64* %_x1015
  %_bop1029 = sub i64 %_load1028, 1
  store i64 %_bop1029, i64* %_x1015
  br label %_while_cond1019
_while_exit1021:
  %_load1031 = load i64, i64* %_acc1017
  ret i64 %_load1031
}
...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  %_call1012 = call i64 @fact(i64 5)
  %_call1013 = call i8* @string_of_int(i64 %_call1012)
  call void @print_string(i8* %_call1013)
  ret i64 0
}
