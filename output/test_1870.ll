...
define i64 @getminindex({ i64, [0 x i64] }* %a, i64 %s, i64 %b) {
  ...
  %_3891 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_a3889, i32 0, i32 1, i64 %_s3890
  %_3892 = load i64, i64* %_3891
  store i64 %_3892, i64* %_min3893
...
_for_body3899:
  ...
  %_3909 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_a3907, i32 0, i32 1, i64 %_i3908
  %_3910 = load i64, i64* %_3909
  %_min3911 = load i64, i64* %_min3893
  %_bop3912 = icmp slt i64 %_3910, %_min3911
  br i1 %_bop3912, label %_then3904, label %_else3905
_then3904:
  %_a3913 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_a3880
  %_i3914 = load i64, i64* %_i3887
  %_3915 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_a3913, i32 0, i32 1, i64 %_i3914
  %_3916 = load i64, i64* %_3915
  store i64 %_3916, i64* %_min3893
...
_for_body3849:
  ...
  %_3861 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_a3859, i32 0, i32 1, i64 %_i3860
  %_3862 = load i64, i64* %_3861
  store i64 %_3862, i64* %_t3842
  %_a3864 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_a3838
  %_mi3865 = load i64, i64* %_mi3844
  %_3866 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_a3864, i32 0, i32 1, i64 %_mi3865
  %_3867 = load i64, i64* %_3866
...
_for_body3826:
  ...
  %_3832 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_ar3830, i32 0, i32 1, i64 %_i3831
  %_3833 = load i64, i64* %_3832
  call void @print_int(i64 %_3833)
