...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  %_argv7545 = alloca { i64, [0 x i8*] }*
  %_counter7548 = alloca i64
  %_x7550 = alloca i64
  %_y7552 = alloca i64
  store i64 %argc, i64* %_argc7544
  store { i64, [0 x i8*] }* %argv, { i64, [0 x i8*] }** %_argv7545
  store i64 0, i64* %_counter7548
  store i64 0, i64* %_x7550
  store i64 10, i64* %_y7552
  br label %_for_cond7554
_for_cond7554:
  %_x7557 = load i64, i64* %_x7550
  %_bop7558 = icmp slt i64 %_x7557, 10
  br i1 %_bop7558, label %_for_body7555, label %_for_exit7556
_for_body7555:
  %_counter7559 = load i64, i64* %_counter7548
  %_bop7560 = add i64 %_counter7559, 1
  store i64 %_bop7560, i64* %_counter7548
  %_x7562 = load i64, i64* %_x7550
  %_bop7563 = add i64 %_x7562, 2
  store i64 %_bop7563, i64* %_x7550
  br label %_for_cond7554
_for_exit7556:
  %_counter7565 = load i64, i64* %_counter7548
  ret i64 %_counter7565
}
