...
_join4836:
  ...
  %_funcall4841 = call i64 @fibR(i64 %_bop4840)
  %_n4842 = load i64, i64* %_n4827
  %_bop4843 = sub i64 %_n4842, 2
  %_funcall4844 = call i64 @fibR(i64 %_bop4843)
  %_bop4845 = add i64 %_funcall4841, %_funcall4844
  ret i64 %_bop4845
}
...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  %_funcall4781 = call i64 @fibR(i64 12)
  %_bop4782 = icmp eq i64 %_funcall4781, 144
  %_funcall4783 = call i64 @fibI(i64 12)
  %_bop4784 = icmp eq i64 %_funcall4783, 144
