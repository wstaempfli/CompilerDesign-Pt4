...
_for_exit5967:
  ...
  %_elem_addr5987 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_partial5986, i32 0, i32 1, i32 0
  %_read_val5988 = load i64, i64* %_elem_addr5987
  %_bop5989 = icmp slt i64 %_insertee5985, %_read_val5988
...
_then6003:
  ...
  %_elem_addr6013 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_partial6011, i32 0, i32 1, i64 %_i6012
  %_read_val6014 = load i64, i64* %_elem_addr6013
  %_bop6015 = icmp sgt i64 %_insertee6010, %_read_val6014
...
_then6007:
  ...
  %_elem_addr6025 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_partial6023, i32 0, i32 1, i64 %_i6024
  %_read_val6026 = load i64, i64* %_elem_addr6025
  ...
  store i64 %_read_val6026, i64* %_gep6029
  br label %_join6009
_else6008:
  %_partial6031 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_partial5951
  %_i6032 = load i64, i64* %_i5995
  %_elem_addr6033 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_partial6031, i32 0, i32 1, i64 %_i6032
  %_read_val6034 = load i64, i64* %_elem_addr6033
  ...
  store i64 %_read_val6034, i64* %_gep6037
  br label %_join6009
_join6009:
  br label %_join6005
_else6004:
  ...
  %_elem_addr6041 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_partial6039, i32 0, i32 1, i64 %_i6040
  %_read_val6042 = load i64, i64* %_elem_addr6041
  ...
  store i64 %_read_val6042, i64* %_gep6046
  br label %_join6005
_join6005:
...
define { i64, [0 x i64] }* @insort({ i64, [0 x i64] }* %unsorted, i64 %len) {
  ...
  %_elem_addr5926 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_unsorted5925, i32 0, i32 1, i32 0
  %_read_val5927 = load i64, i64* %_elem_addr5926
  %_out5928 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_out5923
  %_gep5929 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_out5928, i32 0, i32 1, i32 0
  store i64 %_read_val5927, i64* %_gep5929
...
_for_body5934:
  ...
  %_elem_addr5943 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_unsorted5941, i32 0, i32 1, i64 %_i5942
  %_read_val5944 = load i64, i64* %_elem_addr5943
  %_i5940 = load i64, i64* %_i5931
  %_out5939 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_out5923
  %_funcall5945 = call { i64, [0 x i64] }* @insert({ i64, [0 x i64] }* %_out5939, i64 %_i5940, i64 %_read_val5944)
...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  %_elem_addr5913 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_result5912, i32 0, i32 1, i32 5
  %_read_val5914 = load i64, i64* %_elem_addr5913
  ret i64 %_read_val5914
}
