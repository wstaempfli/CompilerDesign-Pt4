...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  %_argv1914 = alloca { i64, [0 x i8*] }*
  %_a1924 = alloca { i64, [0 x i64] }*
  store i64 %argc, i64* %_argc1912
  store { i64, [0 x i8*] }* %argv, { i64, [0 x i8*] }** %_argv1914
  ...
  %_load1926 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_a1924
  %_gep1927 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_load1926, i32 0, i32 1, i32 2
  %_load1928 = load i64, i64* %_gep1927
  ret i64 %_load1928
}
