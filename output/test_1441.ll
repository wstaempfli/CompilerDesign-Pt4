...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  %_function3783 = call i8* @string_of_array({ i64, [0 x i64] }* %_a3782)
  call void @print_string(i8* %_function3783)
  ...
  %_function3791 = call i8* @string_of_array({ i64, [0 x i64] }* %_a3790)
  call void @print_string(i8* %_function3791)
