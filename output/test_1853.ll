...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  %_2702 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_b2701, i32 0, i32 1, i32 0
  %_2703 = load i64, i64* %_2702
  %_bop2704 = add i64 %_a2700, %_2703
  %_b2705 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_b2692
  %_2706 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_b2705, i32 0, i32 1, i32 1
  %_2707 = load i64, i64* %_2706
  %_bop2708 = add i64 %_bop2704, %_2707
  ret i64 %_bop2708
}
