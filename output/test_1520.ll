...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  %_elem_addr1908 = getelementptr { i64, [0 x { i64, [0 x i64] }*] }, { i64, [0 x { i64, [0 x i64] }*] }* %_b1907, i32 0, i32 1, i32 2
  %_read_val1909 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_elem_addr1908
  %_elem_addr1910 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_read_val1909, i32 0, i32 1, i32 1
  %_read_val1911 = load i64, i64* %_elem_addr1910
  ret i64 %_read_val1911
}
