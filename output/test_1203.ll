...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  %_argv7320 = alloca { i64, [0 x i8*] }*
  store i64 %argc, i64* %_argc7318
  store { i64, [0 x i8*] }* %argv, { i64, [0 x i8*] }** %_argv7320
  ...
  %_load7331 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** @x
  %_gep7332 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_load7331, i32 0, i32 1, i32 2
