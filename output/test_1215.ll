...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  %_argv7446 = alloca { i64, [0 x i8*] }*
  %_x7449 = alloca i64
  store i64 %argc, i64* %_argc7444
  store { i64, [0 x i8*] }* %argv, { i64, [0 x i8*] }** %_argv7446
  %_uop7448 = sub i64 0, 10
  store i64 %_uop7448, i64* %_x7449
  br label %_while_cond7451
_while_cond7451:
  %_load7454 = load i64, i64* %_x7449
  %_bop7455 = icmp sle i64 %_load7454, 0
  br i1 %_bop7455, label %_while_body7452, label %_while_exit7453
_while_body7452:
  %_load7456 = load i64, i64* %_x7449
  %_bop7457 = add i64 %_load7456, 1
  store i64 %_bop7457, i64* %_x7449
  br label %_while_cond7451
_while_exit7453:
  %_load7459 = load i64, i64* %_x7449
  ret i64 %_load7459
}
