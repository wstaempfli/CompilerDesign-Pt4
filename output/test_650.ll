...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  store { i64, [0 x i8*] }* %argv, { i64, [0 x i8*] }** %_argv7145
  ...
  %_one7224 = load i64, i64* %_one7182
  %_gep_lit7225 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_array7223, i32 0, i32 1, i32 0
  store i64 %_one7224, i64* %_gep_lit7225
  %_one7227 = load i64, i64* %_one7182
  %_one7228 = load i64, i64* %_one7182
  %_bop7229 = sub i64 %_one7227, %_one7228
  ...
  %_one7240 = load i64, i64* %_one7182
  %_gep_lit7241 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_array7237, i32 0, i32 1, i32 1
  store i64 %_one7240, i64* %_gep_lit7241
  %_one7243 = load i64, i64* %_one7182
  %_one7244 = load i64, i64* %_one7182
  %_bop7245 = add i64 %_one7243, %_one7244
  ...
  %_one7266 = load i64, i64* %_one7182
  %_one7267 = load i64, i64* %_one7182
  %_uop7268 = xor i64 %_one7267, -1
  %_bop7269 = icmp eq i64 %_one7266, %_uop7268
  %_mat_27264 = load { i64, [0 x { i64, [0 x i64] }*] }*, { i64, [0 x { i64, [0 x i64] }*] }** %_mat_27261
  %_mat_17263 = load { i64, [0 x { i64, [0 x i64] }*] }*, { i64, [0 x { i64, [0 x i64] }*] }** %_mat_17218
  %_call7265 = call { i64, [0 x { i64, [0 x i64] }*] }* @mult({ i64, [0 x { i64, [0 x i64] }*] }* %_mat_17263, { i64, [0 x { i64, [0 x i64] }*] }* %_mat_27264)
  call void @print_matrix({ i64, [0 x { i64, [0 x i64] }*] }* %_call7265, i1 %_bop7269)
  %_one7274 = load i64, i64* %_one7182
  %_one7275 = load i64, i64* %_one7182
  %_bop7276 = icmp eq i64 %_one7274, %_one7275
...
define { i64, [0 x { i64, [0 x i64] }*] }* @mult({ i64, [0 x { i64, [0 x i64] }*] }* %mata, { i64, [0 x { i64, [0 x i64] }*] }* %matb) {
  ...
  %_matb7063 = alloca { i64, [0 x { i64, [0 x i64] }*] }*
  %_res7067 = alloca { i64, [0 x { i64, [0 x i64] }*] }*
  %_i7069 = alloca i64
  %_j7076 = alloca i64
  %_k7083 = alloca i64
  store { i64, [0 x { i64, [0 x i64] }*] }* %mata, { i64, [0 x { i64, [0 x i64] }*] }** %_mata7062
  store { i64, [0 x { i64, [0 x i64] }*] }* %matb, { i64, [0 x { i64, [0 x i64] }*] }** %_matb7063
...
_for_cond7071:
  %_i7074 = load i64, i64* %_i7069
  %_bop7075 = icmp slt i64 %_i7074, 3
  br i1 %_bop7075, label %_for_body7072, label %_for_exit7073
_for_body7072:
  store i64 0, i64* %_j7076
  br label %_for_cond7078
_for_cond7078:
  %_j7081 = load i64, i64* %_j7076
  %_bop7082 = icmp slt i64 %_j7081, 3
  br i1 %_bop7082, label %_for_body7079, label %_for_exit7080
_for_body7079:
  store i64 0, i64* %_k7083
  br label %_for_cond7085
_for_cond7085:
  %_k7088 = load i64, i64* %_k7083
  %_bop7089 = icmp slt i64 %_k7088, 3
  br i1 %_bop7089, label %_for_body7086, label %_for_exit7087
_for_body7086:
  %_res7090 = load { i64, [0 x { i64, [0 x i64] }*] }*, { i64, [0 x { i64, [0 x i64] }*] }** %_res7067
  %_i7091 = load i64, i64* %_i7069
  %_gep7092 = getelementptr { i64, [0 x { i64, [0 x i64] }*] }, { i64, [0 x { i64, [0 x i64] }*] }* %_res7090, i32 0, i32 1, i64 %_i7091
  %_load7093 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_gep7092
  %_j7094 = load i64, i64* %_j7076
  %_gep7095 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_load7093, i32 0, i32 1, i64 %_j7094
  %_load7096 = load i64, i64* %_gep7095
  %_mata7097 = load { i64, [0 x { i64, [0 x i64] }*] }*, { i64, [0 x { i64, [0 x i64] }*] }** %_mata7062
  %_i7098 = load i64, i64* %_i7069
  %_gep7099 = getelementptr { i64, [0 x { i64, [0 x i64] }*] }, { i64, [0 x { i64, [0 x i64] }*] }* %_mata7097, i32 0, i32 1, i64 %_i7098
  %_load7100 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_gep7099
  %_k7101 = load i64, i64* %_k7083
  %_gep7102 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_load7100, i32 0, i32 1, i64 %_k7101
  %_load7103 = load i64, i64* %_gep7102
  %_matb7104 = load { i64, [0 x { i64, [0 x i64] }*] }*, { i64, [0 x { i64, [0 x i64] }*] }** %_matb7063
  %_k7105 = load i64, i64* %_k7083
  %_gep7106 = getelementptr { i64, [0 x { i64, [0 x i64] }*] }, { i64, [0 x { i64, [0 x i64] }*] }* %_matb7104, i32 0, i32 1, i64 %_k7105
  %_load7107 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_gep7106
  %_j7108 = load i64, i64* %_j7076
  %_gep7109 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_load7107, i32 0, i32 1, i64 %_j7108
  %_load7110 = load i64, i64* %_gep7109
  %_bop7111 = mul i64 %_load7103, %_load7110
  %_bop7112 = add i64 %_load7096, %_bop7111
  %_res7113 = load { i64, [0 x { i64, [0 x i64] }*] }*, { i64, [0 x { i64, [0 x i64] }*] }** %_res7067
  %_i7114 = load i64, i64* %_i7069
  %_gep7115 = getelementptr { i64, [0 x { i64, [0 x i64] }*] }, { i64, [0 x { i64, [0 x i64] }*] }* %_res7113, i32 0, i32 1, i64 %_i7114
  %_load7116 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_gep7115
  %_j7117 = load i64, i64* %_j7076
  %_gep7118 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_load7116, i32 0, i32 1, i64 %_j7117
  store i64 %_bop7112, i64* %_gep7118
  %_k7120 = load i64, i64* %_k7083
  %_bop7121 = add i64 %_k7120, 1
  store i64 %_bop7121, i64* %_k7083
  br label %_for_cond7085
_for_exit7087:
  %_j7123 = load i64, i64* %_j7076
  %_bop7124 = add i64 %_j7123, 1
  store i64 %_bop7124, i64* %_j7076
  br label %_for_cond7078
_for_exit7080:
  %_i7126 = load i64, i64* %_i7069
  %_bop7127 = add i64 %_i7126, 1
  store i64 %_bop7127, i64* %_i7069
  br label %_for_cond7071
_for_exit7073:
  %_res7129 = load { i64, [0 x { i64, [0 x i64] }*] }*, { i64, [0 x { i64, [0 x i64] }*] }** %_res7067
  ret { i64, [0 x { i64, [0 x i64] }*] }* %_res7129
}

define void @print_matrix({ i64, [0 x { i64, [0 x i64] }*] }* %mat, i1 %pretty) {
  %_mat7013 = alloca { i64, [0 x { i64, [0 x i64] }*] }*
  %_pretty7014 = alloca i1
  %_i7017 = alloca i64
  %_j7031 = alloca i64
  store { i64, [0 x { i64, [0 x i64] }*] }* %mat, { i64, [0 x { i64, [0 x i64] }*] }** %_mat7013
  store i1 %pretty, i1* %_pretty7014
  store i64 0, i64* %_i7017
  br label %_for_cond7019
_for_cond7019:
  %_i7022 = load i64, i64* %_i7017
  %_bop7023 = icmp slt i64 %_i7022, 3
  br i1 %_bop7023, label %_for_body7020, label %_for_exit7021
_for_body7020:
  %_pretty7027 = load i1, i1* %_pretty7014
  br i1 %_pretty7027, label %_then7024, label %_else7025
_then7024:
...
_for_cond7033:
  %_j7036 = load i64, i64* %_j7031
  %_bop7037 = icmp slt i64 %_j7036, 3
  br i1 %_bop7037, label %_for_body7034, label %_for_exit7035
_for_body7034:
  %_mat7038 = load { i64, [0 x { i64, [0 x i64] }*] }*, { i64, [0 x { i64, [0 x i64] }*] }** %_mat7013
  %_i7039 = load i64, i64* %_i7017
  %_gep7040 = getelementptr { i64, [0 x { i64, [0 x i64] }*] }, { i64, [0 x { i64, [0 x i64] }*] }* %_mat7038, i32 0, i32 1, i64 %_i7039
  %_load7041 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_gep7040
  %_j7042 = load i64, i64* %_j7031
  %_gep7043 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_load7041, i32 0, i32 1, i64 %_j7042
  ...
  %_j7049 = load i64, i64* %_j7031
  %_bop7050 = add i64 %_j7049, 1
  store i64 %_bop7050, i64* %_j7031
  br label %_for_cond7033
_for_exit7035:
  %_pretty7055 = load i1, i1* %_pretty7014
  br i1 %_pretty7055, label %_then7052, label %_else7053
_then7052:
...
_else7053:
  br label %_join7054
_join7054:
  %_i7059 = load i64, i64* %_i7017
  %_bop7060 = add i64 %_i7059, 1
