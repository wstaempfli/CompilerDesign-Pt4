...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  %_argv1950 = alloca { i64, [0 x i8*] }*
  %_a1960 = alloca { i64, [0 x i64] }*
  store i64 %argc, i64* %_argc1948
  store { i64, [0 x i8*] }* %argv, { i64, [0 x i8*] }** %_argv1950
  ...
  %_load1962 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_a1960
  %_gep1963 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_load1962, i32 0, i32 1, i32 2
