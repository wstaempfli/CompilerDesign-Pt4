...
define i64 @val_at({ i64, [0 x { i64, [0 x i64] }*] }* %board, i64 %i, i64 %j) {
  ...
  %_function5663 = call i64 @check({ i64, [0 x { i64, [0 x i64] }*] }* %_board5657, i64 %_bop5659, i64 %_bop5661, i64 %_count5662)
  store i64 %_function5663, i64* %_count5655
  ...
  %_function5670 = call i64 @check({ i64, [0 x { i64, [0 x i64] }*] }* %_board5665, i64 %_bop5667, i64 %_j5668, i64 %_count5669)
  store i64 %_function5670, i64* %_count5655
  ...
  %_function5678 = call i64 @check({ i64, [0 x { i64, [0 x i64] }*] }* %_board5672, i64 %_bop5674, i64 %_bop5676, i64 %_count5677)
  store i64 %_function5678, i64* %_count5655
  ...
  %_function5685 = call i64 @check({ i64, [0 x { i64, [0 x i64] }*] }* %_board5680, i64 %_i5681, i64 %_bop5683, i64 %_count5684)
  store i64 %_function5685, i64* %_count5655
  ...
  %_function5692 = call i64 @check({ i64, [0 x { i64, [0 x i64] }*] }* %_board5687, i64 %_i5688, i64 %_bop5690, i64 %_count5691)
  store i64 %_function5692, i64* %_count5655
  ...
  %_function5700 = call i64 @check({ i64, [0 x { i64, [0 x i64] }*] }* %_board5694, i64 %_bop5696, i64 %_bop5698, i64 %_count5699)
  store i64 %_function5700, i64* %_count5655
  ...
  %_function5707 = call i64 @check({ i64, [0 x { i64, [0 x i64] }*] }* %_board5702, i64 %_bop5704, i64 %_j5705, i64 %_count5706)
  store i64 %_function5707, i64* %_count5655
  ...
  %_function5715 = call i64 @check({ i64, [0 x { i64, [0 x i64] }*] }* %_board5709, i64 %_bop5711, i64 %_bop5713, i64 %_count5714)
  store i64 %_function5715, i64* %_count5655
...
_for_body5589:
  ...
  %_function5596 = call i64 @val_at({ i64, [0 x { i64, [0 x i64] }*] }* %_board5593, i64 %_i5594, i64 %_j5595)
  ...
  store i64 %_function5596, i64* %_gep5602
