...
_join5798:
  ...
  %_function5807 = call { i64, [0 x i64] }* @array_of_string(i8* %_a5806)
  store { i64, [0 x i64] }* %_function5807, { i64, [0 x i64] }** %_a_chars5808
  %_b5810 = load i8*, i8** %_b5791
  %_function5811 = call { i64, [0 x i64] }* @array_of_string(i8* %_b5810)
  store { i64, [0 x i64] }* %_function5811, { i64, [0 x i64] }** %_b_chars5812
  %_a_chars5814 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_a_chars5808
  %_i5815 = load i64, i64* %_i5788
  %_gep5816 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_a_chars5814, i32 0, i32 1, i64 %_i5815
  ...
  %_gep5822 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_b_chars5820, i32 0, i32 1, i64 %_j5821
...
_then5826:
  ...
  %_function5838 = call i8* @lcs(i64 %_bop5833, i64 %_bop5835, i8* %_a5836, i8* %_b5837)
  store i8* %_function5838, i8** %_prev_lcs5839
  %_a_chars5841 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_a_chars5808
  %_i5842 = load i64, i64* %_i5788
  %_gep5843 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_a_chars5841, i32 0, i32 1, i64 %_i5842
  ...
  %_function5849 = call i8* @string_of_array({ i64, [0 x i64] }* %_buf5848)
  store i8* %_function5849, i8** %_next_char5850
  %_next_char5853 = load i8*, i8** %_next_char5850
  %_prev_lcs5852 = load i8*, i8** %_prev_lcs5839
  %_function5854 = call i8* @string_cat(i8* %_prev_lcs5852, i8* %_next_char5853)
  ret i8* %_function5854
_else5827:
  br label %_join5828
_join5828:
  ...
  %_function5860 = call i8* @lcs(i64 %_i5855, i64 %_bop5857, i8* %_a5858, i8* %_b5859)
  store i8* %_function5860, i8** %_left_lcs5861
  ...
  %_function5868 = call i8* @lcs(i64 %_bop5864, i64 %_j5865, i8* %_a5866, i8* %_b5867)
  store i8* %_function5868, i8** %_right_lcs5869
  %_left_lcs5871 = load i8*, i8** %_left_lcs5861
  %_function5872 = call i64 @length_of_string(i8* %_left_lcs5871)
  store i64 %_function5872, i64* %_left_len5873
  %_right_lcs5875 = load i8*, i8** %_right_lcs5869
  %_function5876 = call i64 @length_of_string(i8* %_right_lcs5875)
  store i64 %_function5876, i64* %_right_len5877
...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  %_function5786 = call i8* @lcs(i64 5, i64 6, i8* %_tomato5784, i8* %_orating5785)
  call void @print_string(i8* %_function5786)
  ret i64 0
}
