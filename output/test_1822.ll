...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  %_959 = getelementptr { i64, [0 x { i64, [0 x i64] }*] }, { i64, [0 x { i64, [0 x i64] }*] }* %_a2958, i32 0, i32 1, i32 0
  %_960 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_959
  %_gep961 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_960, i32 0, i32 1, i32 0
  ...
  %_976 = getelementptr { i64, [0 x { i64, [0 x i64] }*] }, { i64, [0 x { i64, [0 x i64] }*] }* %_a3975, i32 0, i32 1, i32 0
  %_977 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_976
  %_978 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_977, i32 0, i32 1, i32 0
  %_979 = load i64, i64* %_978
  ret i64 %_979
}
