...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  store i64 17, i64* %_elem_ptr410
  %_elem_ptr410 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_call409, i32 0, i32 1, i32 0
  %_y408 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_y405
  %_x407 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_x401
  %_call409 = call { i64, [0 x i64] }* @f({ i64, [0 x i64] }* %_x407, { i64, [0 x i64] }* %_y408, i1 1)
  %_x412 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_x401
  %_gep413 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_x412, i32 0, i32 1, i32 0
