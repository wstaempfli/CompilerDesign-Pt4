...
define i64 @f({ i64, [0 x i64] }* %arr) {
  ...
  %_elem_addr1496 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_arr1495, i32 0, i32 1, i32 3
  %_read_val1497 = load i64, i64* %_elem_addr1496
  ret i64 %_read_val1497
}
...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  %_funcall1429 = call { i64, [0 x i64] }* @g()
  store { i64, [0 x i64] }* %_funcall1429, { i64, [0 x i64] }** %_arr41430
  ...
  %_elem_addr1450 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_arr11449, i32 0, i32 1, i32 1
  %_read_val1451 = load i64, i64* %_elem_addr1450
  %_bop1452 = add i64 %_c1448, %_read_val1451
  store i64 %_bop1452, i64* %_c1427
  %_c1454 = load i64, i64* %_c1427
  %_arr21455 = load { i64, [0 x { i64, [0 x i64] }*] }*, { i64, [0 x { i64, [0 x i64] }*] }** %_arr21425
  %_elem_addr1456 = getelementptr { i64, [0 x { i64, [0 x i64] }*] }, { i64, [0 x { i64, [0 x i64] }*] }* %_arr21455, i32 0, i32 1, i32 1
  %_read_val1457 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_elem_addr1456
  %_elem_addr1458 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_read_val1457, i32 0, i32 1, i32 1
  %_read_val1459 = load i64, i64* %_elem_addr1458
  %_bop1460 = add i64 %_c1454, %_read_val1459
  store i64 %_bop1460, i64* %_c1427
  %_c1462 = load i64, i64* %_c1427
  %_arr31463 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_arr31442
  %_elem_addr1464 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_arr31463, i32 0, i32 1, i32 3
  %_read_val1465 = load i64, i64* %_elem_addr1464
  %_bop1466 = add i64 %_c1462, %_read_val1465
  store i64 %_bop1466, i64* %_c1427
  %_c1468 = load i64, i64* %_c1427
  %_arr31469 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_arr31442
  %_funcall1470 = call i64 @f({ i64, [0 x i64] }* %_arr31469)
  %_bop1471 = add i64 %_c1468, %_funcall1470
  store i64 %_bop1471, i64* %_c1427
  %_c1473 = load i64, i64* %_c1427
  %_arr41474 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_arr41430
  %_elem_addr1475 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_arr41474, i32 0, i32 1, i32 1
  %_read_val1476 = load i64, i64* %_elem_addr1475
  %_bop1477 = add i64 %_c1473, %_read_val1476
