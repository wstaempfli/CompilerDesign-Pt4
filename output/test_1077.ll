...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  %_argc158 = alloca i64
  %_argv160 = alloca { i64, [0 x i8*] }*
  %_x188 = alloca { i64, [0 x { i64, [0 x i64] }*] }*
  %_ans190 = alloca i64
  %_i192 = alloca i64
  store i64 %argc, i64* %_argc158
  store { i64, [0 x i8*] }* %argv, { i64, [0 x i8*] }** %_argv160
...
_for_cond194:
  %_load197 = load i64, i64* %_i192
  %_bop198 = icmp slt i64 %_load197, 4
  br i1 %_bop198, label %_for_body195, label %_for_exit196
_for_body195:
  %_load199 = load { i64, [0 x { i64, [0 x i64] }*] }*, { i64, [0 x { i64, [0 x i64] }*] }** %_x188
  %_load200 = load i64, i64* %_i192
  %_gep201 = getelementptr { i64, [0 x { i64, [0 x i64] }*] }, { i64, [0 x { i64, [0 x i64] }*] }* %_load199, i32 0, i32 1, i64 %_load200
  ...
  %_load205 = load i64, i64* %_ans190
  %_bop206 = sub i64 %_load204, %_load205
  store i64 %_bop206, i64* %_ans190
  %_load208 = load i64, i64* %_i192
  %_bop209 = add i64 %_load208, 1
...
_then211:
  %_load218 = load i64, i64* %_ans190
  ret i64 %_load218
_else212:
  %_load219 = load i64, i64* %_ans190
  %_uop220 = sub i64 0, %_load219
  ret i64 %_uop220
_join213:
  %_load221 = load i64, i64* %_ans190
  ret i64 %_load221
}
