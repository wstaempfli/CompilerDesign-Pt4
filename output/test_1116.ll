...
define i64 @g({ i64, [0 x i64] }* %y) {
  ...
  %_load1105 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_y1103
  %_gep1106 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_load1105, i32 0, i32 1, i32 2
...
_for_cond1072:
  %_load1075 = load i64, i64* %_j1070
  %_bop1076 = icmp slt i64 %_load1075, 100
  br i1 %_bop1076, label %_for_body1073, label %_for_exit1074
_for_body1073:
  %_load1077 = load i64, i64* %_p1068
  %_bop1078 = add i64 %_load1077, 1
  store i64 %_bop1078, i64* %_p1068
  %_load1080 = load i64, i64* %_j1070
  %_bop1081 = add i64 %_load1080, 1
  store i64 %_bop1081, i64* %_j1070
  br label %_for_cond1072
_for_exit1074:
  %_load1083 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_arr1066
  %_call1084 = call i64 @g({ i64, [0 x i64] }* %_load1083)
  %_load1085 = load i64, i64* @i
  %_call1086 = call i64 @f(i64 %_load1085)
  %_bop1087 = add i64 %_call1084, %_call1086
  %_load1088 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_arr1066
  %_gep1089 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_load1088, i32 0, i32 1, i32 3
  %_load1090 = load i64, i64* %_gep1089
  %_call1091 = call i64 @f(i64 %_load1090)
  %_bop1092 = add i64 %_bop1087, %_call1091
  %_load1093 = load { i64, [0 x { i64, [0 x i64] }*] }*, { i64, [0 x { i64, [0 x i64] }*] }** %_garr1054
  %_gep1094 = getelementptr { i64, [0 x { i64, [0 x i64] }*] }, { i64, [0 x { i64, [0 x i64] }*] }* %_load1093, i32 0, i32 1, i32 1
  ...
  %_load1100 = load i64, i64* %_p1068
  %_call1101 = call i64 @f(i64 %_load1100)
