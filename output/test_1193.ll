...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %args) {
  ...
  %_args6522 = alloca { i64, [0 x i8*] }*
  store i64 %argc, i64* %_argc6520
  store { i64, [0 x i8*] }* %args, { i64, [0 x i8*] }** %_args6522
...
define i64 @function(i64 %x) {
  ...
  %_load6502 = load i64, i64* %_x6497
  %_bop6503 = icmp eq i64 %_load6502, 0
...
_join6506:
  br label %_join6501
_else6500:
  %_load6510 = load i64, i64* %_x6497
  %_bop6511 = icmp eq i64 %_load6510, 1
...
_join6514:
  br label %_join6509
_else6508:
  %_load6518 = load i64, i64* %_x6497
  %_bop6519 = icmp eq i64 %_load6518, 2
