...
define i64 @min({ i64, [0 x i64] }* %arr, i64 %len) {
  ...
  %_load4743 = load i64, i64* %_gep_ptr4742
  %_gep_ptr4742 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_arr4741, i32 0, i32 1, i32 0
...
_for_body4749:
  ...
  %_load4760 = load i64, i64* %_gep_ptr4759
  %_gep_ptr4759 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_arr4757, i32 0, i32 1, i64 %_i4758
...
_then4754:
  ...
  %_load4766 = load i64, i64* %_gep_ptr4765
  %_gep_ptr4765 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_arr4763, i32 0, i32 1, i64 %_i4764
...
define i64 @max({ i64, [0 x i64] }* %arr, i64 %len) {
  ...
  %_load4708 = load i64, i64* %_gep_ptr4707
  %_gep_ptr4707 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_arr4706, i32 0, i32 1, i32 0
...
_for_body4714:
  ...
  %_load4725 = load i64, i64* %_gep_ptr4724
  %_gep_ptr4724 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_arr4722, i32 0, i32 1, i64 %_i4723
...
_then4719:
  ...
  %_load4731 = load i64, i64* %_gep_ptr4730
  %_gep_ptr4730 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_arr4728, i32 0, i32 1, i64 %_i4729
...
_for_body4624:
  ...
  %_load4633 = load i64, i64* %_gep_ptr4632
  %_gep_ptr4632 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_arr4630, i32 0, i32 1, i64 %_i4631
  %_min4634 = load i64, i64* %_min4606
  %_bop4635 = sub i64 %_load4633, %_min4634
  %_load4637 = load i64, i64* %_gep_ptr4636
  %_gep_ptr4636 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_counts4629, i32 0, i32 1, i64 %_bop4635
  ...
  %_load4643 = load i64, i64* %_gep_ptr4642
  %_gep_ptr4642 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_arr4640, i32 0, i32 1, i64 %_i4641
...
_while_body4662:
  ...
  %_load4675 = load i64, i64* %_gep_ptr4674
  %_gep_ptr4674 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_counts4670, i32 0, i32 1, i64 %_bop4673
...
_then4667:
  ...
  %_load4687 = load i64, i64* %_gep_ptr4686
  %_gep_ptr4686 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_counts4682, i32 0, i32 1, i64 %_bop4685
...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  store i64 65, i64* %_gep4563
  %_gep4563 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_array4562, i32 0, i32 1, i32 0
  store i64 70, i64* %_gep4565
  %_gep4565 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_array4562, i32 0, i32 1, i32 1
  store i64 72, i64* %_gep4567
  %_gep4567 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_array4562, i32 0, i32 1, i32 2
  store i64 90, i64* %_gep4569
  %_gep4569 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_array4562, i32 0, i32 1, i32 3
  store i64 65, i64* %_gep4571
  %_gep4571 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_array4562, i32 0, i32 1, i32 4
  store i64 65, i64* %_gep4573
  %_gep4573 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_array4562, i32 0, i32 1, i32 5
  store i64 69, i64* %_gep4575
  %_gep4575 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_array4562, i32 0, i32 1, i32 6
  store i64 89, i64* %_gep4577
  %_gep4577 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_array4562, i32 0, i32 1, i32 7
  store i64 67, i64* %_gep4579
  %_gep4579 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_array4562, i32 0, i32 1, i32 8
