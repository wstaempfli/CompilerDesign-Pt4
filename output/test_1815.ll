...
_for_body707:
  ...
  %_714 = getelementptr { i64, [0 x { i64, [0 x i64] }*] }, { i64, [0 x { i64, [0 x i64] }*] }* %_a712, i32 0, i32 1, i64 %_i713
  %_715 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_714
  %_j716 = load i64, i64* %_j704
  %_717 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_715, i32 0, i32 1, i64 %_j716
  %_718 = load i64, i64* %_717
  %_bop719 = add i64 %_s711, %_718
