...
_while_body5451:
  ...
  %_function5460 = call i64 @mod(i64 %_a5458, i64 %_b5459)
  store i64 %_function5460, i64* %_b5447
...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  %_function5426 = call i64 @gcd(i64 %_a5424, i64 %_b5425)
  ret i64 %_function5426
}
