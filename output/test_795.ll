...
_while_cond5306:
  ...
  br i1 %_bop5311, label %_while_body5307, label %_while_end5308
_while_body5307:
  %_a5315 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_a5298
  %_i5316 = load i64, i64* %_i5302
  %_bop5317 = sub i64 %_i5316, 1
  %_gep5318 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_a5315, i32 0, i32 1, i64 %_bop5317
  %_load5319 = load i64, i64* %_gep5318
  %_a5320 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_a5298
  %_i5321 = load i64, i64* %_i5302
  %_gep5322 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_a5320, i32 0, i32 1, i64 %_i5321
...
_else5313:
  ...
  %_gep5333 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_a5330, i32 0, i32 1, i64 %_bop5332
  %_load5334 = load i64, i64* %_gep5333
  store i64 %_load5334, i64* %_tmp5335
  store i64 %_load5340, i64* %_elem_ptr5344
  %_elem_ptr5344 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_a5341, i32 0, i32 1, i64 %_bop5343
  %_a5337 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_a5298
  %_i5338 = load i64, i64* %_i5302
  %_gep5339 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_a5337, i32 0, i32 1, i64 %_i5338
  ...
  store i64 %_tmp5346, i64* %_elem_ptr5349
  %_elem_ptr5349 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_a5347, i32 0, i32 1, i64 %_i5348
...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  br label %_while_cond5285
_while_cond5285:
  %_i5288 = load i64, i64* %_i5283
  %_bop5289 = icmp slt i64 %_i5288, 8
  br i1 %_bop5289, label %_while_body5286, label %_while_end5287
_while_body5286:
  %_arr5290 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_arr5276
  %_i5291 = load i64, i64* %_i5283
  %_gep5292 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_arr5290, i32 0, i32 1, i64 %_i5291
