...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %args) {
  ...
  %_args6441 = alloca { i64, [0 x i8*] }*
  store i64 %argc, i64* %_argc6439
  store { i64, [0 x i8*] }* %args, { i64, [0 x i8*] }** %_args6441
...
define i64 @function(i64 %x) {
  ...
  %_load6432 = load i64, i64* %_x6427
  %_bop6433 = icmp eq i64 %_load6432, 0
  br i1 %_bop6433, label %_then6429, label %_else6430
_then6429:
  ret i64 10
_else6430:
  %_load6437 = load i64, i64* %_x6427
  %_bop6438 = icmp eq i64 %_load6437, 1
