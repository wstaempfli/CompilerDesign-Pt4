...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  %_argv6255 = alloca { i64, [0 x i8*] }*
  store i64 %argc, i64* %_argc6253
  store { i64, [0 x i8*] }* %argv, { i64, [0 x i8*] }** %_argv6255
  %_load6257 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** @arr2
  %_call6258 = call i64 @get_index()
  %_gep6259 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_load6257, i32 0, i32 1, i64 %_call6258
  %_load6260 = load i64, i64* %_gep6259
  %_load6261 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** @arr2
  %_load6262 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** @arr
  %_gep6263 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_load6262, i32 0, i32 1, i32 0
  %_load6264 = load i64, i64* %_gep6263
  %_gep6265 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_load6261, i32 0, i32 1, i64 %_load6264
