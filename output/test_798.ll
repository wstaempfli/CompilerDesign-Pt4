...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  br label %_while_cond5575
_while_cond5575:
  %_i5578 = load i64, i64* %_i5573
  %_bop5579 = icmp slt i64 %_i5578, 4
  br i1 %_bop5579, label %_while_body5576, label %_while_end5577
_while_body5576:
  store { i64, [0 x i64] }* %_array5581, { i64, [0 x i64] }** %_elem_ptr5584
  %_elem_ptr5584 = getelementptr { i64, [0 x { i64, [0 x i64] }*] }, { i64, [0 x { i64, [0 x i64] }*] }* %_new_board5582, i32 0, i32 1, i64 %_i5583
  ...
  br label %_while_cond5588
_while_cond5588:
  %_j5591 = load i64, i64* %_j5586
  %_bop5592 = icmp slt i64 %_j5591, 4
  br i1 %_bop5592, label %_while_body5589, label %_while_end5590
_while_body5589:
  store i64 %_call5596, i64* %_elem_ptr5602
  %_elem_ptr5602 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_load5600, i32 0, i32 1, i64 %_j5601
