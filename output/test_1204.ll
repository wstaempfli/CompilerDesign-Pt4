...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  %_argv7336 = alloca { i64, [0 x i8*] }*
  %_arr7339 = alloca { i64, [0 x i64] }*
  store i64 %argc, i64* %_argc7334
  store { i64, [0 x i8*] }* %argv, { i64, [0 x i8*] }** %_argv7336
  ...
  %_load7344 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_arr7339
  %_gep7345 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_load7344, i32 0, i32 1, i32 1
  store i64 5, i64* %_gep7345
  %_load7347 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_arr7339
  %_gep7348 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_load7347, i32 0, i32 1, i32 1
