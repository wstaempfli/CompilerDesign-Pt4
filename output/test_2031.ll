...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  %_elem_addr768 = getelementptr { i64, [0 x { i64, [0 x i64] }*] }, { i64, [0 x { i64, [0 x i64] }*] }* %_a767, i32 0, i32 1, i32 0
  %_read_val769 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_elem_addr768
  %_elem_addr770 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_read_val769, i32 0, i32 1, i32 1
  %_read_val771 = load i64, i64* %_elem_addr770
  ret i64 %_read_val771
}
