...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %args) {
  ...
  %_args7851 = alloca { i64, [0 x i8*] }*
  %_v7856 = alloca { i64, [0 x i64] }*
  store i64 %argc, i64* %_argc7850
  store { i64, [0 x i8*] }* %args, { i64, [0 x i8*] }** %_args7851
  ...
  %_v7858 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_v7856
  %_gep7859 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_v7858, i32 0, i32 1, i32 1
