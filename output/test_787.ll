...
_then4315:
  ...
  %_call4323 = call i64 @euclid_division(i64 %_numerator4320, i64 %_uop4322)
...
_while_cond4338:
  ...
  br i1 %_bop4343, label %_while_body4339, label %_while_end4340
_while_body4339:
...
_while_cond4361:
  ...
  br i1 %_bop4366, label %_while_body4362, label %_while_end4363
_while_body4362:
...
_ifend4271:
  ...
  %_gep4286 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_input4284, i32 0, i32 1, i64 %_midpt4285
  %_load4287 = load i64, i64* %_gep4286
  %_key4288 = load i64, i64* %_key4262
  %_bop4289 = icmp sgt i64 %_load4287, %_key4288
...
_then4281:
  ...
  %_call4295 = call i1 @binary_search({ i64, [0 x i64] }* %_input4290, i64 %_key4291, i64 %_min4292, i64 %_bop4294)
  ret i1 %_call4295
_else4282:
  br label %_ifend4283
_ifend4283:
  ...
  %_gep4301 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_input4299, i32 0, i32 1, i64 %_midpt4300
  %_load4302 = load i64, i64* %_gep4301
  %_key4303 = load i64, i64* %_key4262
  %_bop4304 = icmp slt i64 %_load4302, %_key4303
...
_then4296:
  ...
  %_call4310 = call i1 @binary_search({ i64, [0 x i64] }* %_input4305, i64 %_key4306, i64 %_bop4308, i64 %_max4309)
  ret i1 %_call4310
_else4297:
  ret i1 1
}
...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  br label %_while_cond4224
_while_cond4224:
  %_i4227 = load i64, i64* %_i4222
  %_bop4228 = icmp slt i64 %_i4227, 100
  br i1 %_bop4228, label %_while_body4225, label %_while_end4226
_while_body4225:
  store i64 %_bop4231, i64* %_elem_ptr4234
  %_elem_ptr4234 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_test_array4232, i32 0, i32 1, i64 %_i4233
  ...
  br label %_while_end4226
_while_end4226:
  %_test_array4239 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_test_array4220
  %_call4240 = call i1 @binary_search({ i64, [0 x i64] }* %_test_array4239, i64 80, i64 0, i64 99)
  store i1 %_call4240, i1* %_even4241
  %_test_array4243 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_test_array4220
  %_call4244 = call i1 @binary_search({ i64, [0 x i64] }* %_test_array4243, i64 81, i64 0, i64 99)
