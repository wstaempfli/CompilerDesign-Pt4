...
_for_body5216:
  ...
  %_function5225 = call i8* @string_of_bool(i1 %_load5224)
  call void @print_string(i8* %_function5225)
...
_for_body5154:
  ...
  %_function5169 = call i1 @xor(i1 %_load5163, i1 %_load5168)
  store i1 %_function5169, i1* %_new_first5170
