...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  store i8* %_strptr1972, i8** %_gep1973
  %_gep1973 = getelementptr { i64, [0 x i8*] }, { i64, [0 x i8*] }* %_array1970, i32 0, i32 1, i32 0
  %_strptr1976 = bitcast [4 x i8]* @_str1975 to i8*
  store i8* %_strptr1976, i8** %_gep1977
  %_gep1977 = getelementptr { i64, [0 x i8*] }, { i64, [0 x i8*] }* %_array1970, i32 0, i32 1, i32 1
  store { i64, [0 x i8*] }* %_array1970, { i64, [0 x i8*] }** %_strs1979
  %_strs1981 = load { i64, [0 x i8*] }*, { i64, [0 x i8*] }** %_strs1979
  %_load1983 = load i8*, i8** %_gep_ptr1982
  %_gep_ptr1982 = getelementptr { i64, [0 x i8*] }, { i64, [0 x i8*] }* %_strs1981, i32 0, i32 1, i32 0
  call void @print_string(i8* %_load1983)
  ret i64 0
}
