...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  %_load1847 = load i64, i64* %_x1841
  %_bop1848 = add i64 %_load1847, 0
  ...
  %_load1852 = load i64, i64* %_x1841
  %_bop1853 = add i64 %_load1852, 0
  ...
  %_load1857 = load i64, i64* %_x1841
  %_bop1858 = add i64 %_load1857, 0
  ...
  %_load1866 = load i64, i64* %_x1841
  %_bop1867 = add i64 %_load1866, 1
  ...
  %_load1871 = load i64, i64* %_x1841
  %_bop1872 = add i64 %_load1871, 1
  ...
  %_load1876 = load i64, i64* %_x1841
  %_bop1877 = add i64 %_load1876, 1
  ...
  %_load1885 = load i64, i64* %_x1841
  %_bop1886 = add i64 %_load1885, 2
  ...
  %_load1890 = load i64, i64* %_x1841
  %_bop1891 = add i64 %_load1890, 2
  ...
  %_load1895 = load i64, i64* %_x1841
  %_bop1896 = add i64 %_load1895, 2
  ...
  %_load1904 = load { i64, [0 x { i64, [0 x i64] }*] }*, { i64, [0 x { i64, [0 x i64] }*] }** %_a1902
  store { i64, [0 x { i64, [0 x i64] }*] }* %_load1904, { i64, [0 x { i64, [0 x i64] }*] }** %_b1905
  %_load1907 = load { i64, [0 x { i64, [0 x i64] }*] }*, { i64, [0 x { i64, [0 x i64] }*] }** %_b1905
  %_gep1908 = getelementptr { i64, [0 x { i64, [0 x i64] }*] }, { i64, [0 x { i64, [0 x i64] }*] }* %_load1907, i32 0, i32 1, i32 2
  %_load1909 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_gep1908
  %_gep1910 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_load1909, i32 0, i32 1, i32 1
  %_load1911 = load i64, i64* %_gep1910
  ret i64 %_load1911
}
