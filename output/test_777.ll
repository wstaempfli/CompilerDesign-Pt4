...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  br label %_while_cond2962
_while_cond2962:
  %_i2965 = load i64, i64* %_i2960
  %_bop2966 = icmp slt i64 %_i2965, 10
  br i1 %_bop2966, label %_while_body2963, label %_while_end2964
_while_body2963:
  store i64 %_i2967, i64* %_elem_ptr2970
  %_elem_ptr2970 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_arr2968, i32 0, i32 1, i64 %_i2969
  ...
  br label %_while_end2964
_while_end2964:
  store i64 0, i64* %_i2975
  br label %_while_cond2977
_while_cond2977:
  %_i2980 = load i64, i64* %_i2975
  %_bop2981 = icmp slt i64 %_i2980, 10
  br i1 %_bop2981, label %_while_body2978, label %_while_end2979
_while_body2978:
  %_sum2982 = load i64, i64* %_sum2958
  %_arr2983 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_arr2956
  %_i2984 = load i64, i64* %_i2975
  %_gep2985 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_arr2983, i32 0, i32 1, i64 %_i2984
