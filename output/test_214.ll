...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  store i64 1, i64* %_gep166
  %_gep166 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_array165, i32 0, i32 1, i32 0
  store { i64, [0 x i64] }* %_array165, { i64, [0 x i64] }** %_gep168
  %_gep168 = getelementptr { i64, [0 x { i64, [0 x i64] }*] }, { i64, [0 x { i64, [0 x i64] }*] }* %_array163, i32 0, i32 1, i32 0
  %_raw_array170 = call i64* @oat_alloc_array(i64 1)
  %_array171 = bitcast i64* %_raw_array170 to { i64, [0 x i64] }*
  store i64 2, i64* %_gep172
  %_gep172 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_array171, i32 0, i32 1, i32 0
  store { i64, [0 x i64] }* %_array171, { i64, [0 x i64] }** %_gep174
  %_gep174 = getelementptr { i64, [0 x { i64, [0 x i64] }*] }, { i64, [0 x { i64, [0 x i64] }*] }* %_array163, i32 0, i32 1, i32 1
  %_raw_array176 = call i64* @oat_alloc_array(i64 1)
  %_array177 = bitcast i64* %_raw_array176 to { i64, [0 x i64] }*
  store i64 3, i64* %_gep178
  %_gep178 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_array177, i32 0, i32 1, i32 0
  store { i64, [0 x i64] }* %_array177, { i64, [0 x i64] }** %_gep180
  %_gep180 = getelementptr { i64, [0 x { i64, [0 x i64] }*] }, { i64, [0 x { i64, [0 x i64] }*] }* %_array163, i32 0, i32 1, i32 2
  %_raw_array182 = call i64* @oat_alloc_array(i64 1)
  %_array183 = bitcast i64* %_raw_array182 to { i64, [0 x i64] }*
  store i64 4, i64* %_gep184
  %_gep184 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_array183, i32 0, i32 1, i32 0
  store { i64, [0 x i64] }* %_array183, { i64, [0 x i64] }** %_gep186
  %_gep186 = getelementptr { i64, [0 x { i64, [0 x i64] }*] }, { i64, [0 x { i64, [0 x i64] }*] }* %_array163, i32 0, i32 1, i32 3
...
_for_body195:
  ...
  %_load202 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_gep_ptr201
  %_gep_ptr201 = getelementptr { i64, [0 x { i64, [0 x i64] }*] }, { i64, [0 x { i64, [0 x i64] }*] }* %_x199, i32 0, i32 1, i64 %_i200
  %_load204 = load i64, i64* %_gep_ptr203
  %_gep_ptr203 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_load202, i32 0, i32 1, i32 0
