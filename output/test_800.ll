...
define { i64, [0 x i64] }* @insert({ i64, [0 x i64] }* %partial, i64 %len, i64 %insertee) {
  ...
  br label %_while_cond5965
_while_cond5965:
  %_i5968 = load i64, i64* %_i5963
  %_len5969 = load i64, i64* %_len5952
  %_bop5970 = add i64 %_len5969, 1
  %_bop5971 = icmp slt i64 %_i5968, %_bop5970
  br i1 %_bop5971, label %_while_body5966, label %_while_end5967
_while_body5966:
  store i64 %_uop5972, i64* %_elem_ptr5975
  %_elem_ptr5975 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_inserted5973, i32 0, i32 1, i64 %_i5974
...
_while_end5967:
  ...
  %_gep5987 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_partial5986, i32 0, i32 1, i32 0
  %_load5988 = load i64, i64* %_gep5987
  %_bop5989 = icmp slt i64 %_insertee5985, %_load5988
  br i1 %_bop5989, label %_then5982, label %_else5983
_then5982:
  store i1 0, i1* %_not_yet_inserted5980
  store i64 %_insertee5991, i64* %_elem_ptr5993
  %_elem_ptr5993 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_inserted5992, i32 0, i32 1, i32 0
...
_then6003:
  ...
  %_gep6013 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_partial6011, i32 0, i32 1, i64 %_i6012
  %_load6014 = load i64, i64* %_gep6013
  %_bop6015 = icmp sgt i64 %_insertee6010, %_load6014
  br i1 %_bop6015, label %_then6007, label %_else6008
_then6007:
  store i1 0, i1* %_not_yet_inserted5980
  store i64 %_insertee6017, i64* %_elem_ptr6021
  %_elem_ptr6021 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_inserted6018, i32 0, i32 1, i64 %_bop6020
  ...
  store i64 %_load6026, i64* %_elem_ptr6029
  %_elem_ptr6029 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_inserted6027, i32 0, i32 1, i64 %_i6028
  %_partial6023 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_partial5951
  %_i6024 = load i64, i64* %_i5995
  %_gep6025 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_partial6023, i32 0, i32 1, i64 %_i6024
  %_load6026 = load i64, i64* %_gep6025
  %_i6028 = load i64, i64* %_i5995
  %_inserted6027 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_inserted5961
  br label %_ifend6009
_else6008:
  store i64 %_load6034, i64* %_elem_ptr6037
  %_elem_ptr6037 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_inserted6035, i32 0, i32 1, i64 %_i6036
  %_partial6031 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_partial5951
  %_i6032 = load i64, i64* %_i5995
  %_gep6033 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_partial6031, i32 0, i32 1, i64 %_i6032
...
_ifend6009:
  br label %_ifend6005
_else6004:
  store i64 %_load6042, i64* %_elem_ptr6046
  %_elem_ptr6046 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_inserted6043, i32 0, i32 1, i64 %_bop6045
  %_partial6039 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_partial5951
  %_i6040 = load i64, i64* %_i5995
  %_gep6041 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_partial6039, i32 0, i32 1, i64 %_i6040
...
define { i64, [0 x i64] }* @insort({ i64, [0 x i64] }* %unsorted, i64 %len) {
  ...
  store i64 %_load5927, i64* %_elem_ptr5929
  %_elem_ptr5929 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_out5928, i32 0, i32 1, i32 0
  %_unsorted5925 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_unsorted5915
  %_gep5926 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_unsorted5925, i32 0, i32 1, i32 0
  %_load5927 = load i64, i64* %_gep5926
  %_out5928 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_out5923
  store i64 1, i64* %_i5931
  br label %_while_cond5933
_while_cond5933:
  %_i5936 = load i64, i64* %_i5931
  %_len5937 = load i64, i64* %_len5916
  %_bop5938 = icmp slt i64 %_i5936, %_len5937
  br i1 %_bop5938, label %_while_body5934, label %_while_end5935
_while_body5934:
  %_unsorted5941 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_unsorted5915
  %_i5942 = load i64, i64* %_i5931
  %_gep5943 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_unsorted5941, i32 0, i32 1, i64 %_i5942
  %_load5944 = load i64, i64* %_gep5943
  %_i5940 = load i64, i64* %_i5931
  %_out5939 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_out5923
  %_call5945 = call { i64, [0 x i64] }* @insert({ i64, [0 x i64] }* %_out5939, i64 %_i5940, i64 %_load5944)
...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  %_call5909 = call { i64, [0 x i64] }* @insort({ i64, [0 x i64] }* %_array5908, i64 6)
  store { i64, [0 x i64] }* %_call5909, { i64, [0 x i64] }** %_result5910
  %_result5912 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_result5910
  %_gep5913 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_result5912, i32 0, i32 1, i32 5
