...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %args) {
  ...
  %_args6420 = alloca { i64, [0 x i8*] }*
  store i64 %argc, i64* %_argc6418
  store { i64, [0 x i8*] }* %args, { i64, [0 x i8*] }** %_args6420
...
define i64 @function(i64 %x) {
  ...
  %_load6411 = load i64, i64* %_x6406
  %_bop6412 = icmp eq i64 %_load6411, 0
  br i1 %_bop6412, label %_then6408, label %_else6409
_then6408:
  ret i64 10
_else6409:
  %_load6416 = load i64, i64* %_x6406
  %_bop6417 = icmp eq i64 %_load6416, 1
