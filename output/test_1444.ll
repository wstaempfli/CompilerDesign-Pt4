...
_then4315:
  ...
  %_function4323 = call i64 @euclid_division(i64 %_numerator4320, i64 %_uop4322)
  %_uop4324 = sub i64 0, %_function4323
  ret i64 %_uop4324
_else4316:
  br label %_join4317
_join4317:
...
_join4271:
  ...
  %_function4278 = call i64 @euclid_division(i64 %_bop4277, i64 2)
  store i64 %_function4278, i64* %_midpt4279
...
_then4281:
  ...
  %_function4295 = call i1 @binary_search({ i64, [0 x i64] }* %_input4290, i64 %_key4291, i64 %_min4292, i64 %_bop4294)
  ret i1 %_function4295
_else4282:
  br label %_join4283
_join4283:
...
_then4296:
  ...
  %_function4310 = call i1 @binary_search({ i64, [0 x i64] }* %_input4305, i64 %_key4306, i64 %_bop4308, i64 %_max4309)
  ret i1 %_function4310
_else4297:
  ret i1 1
}
...
_for_exit4226:
  ...
  %_function4240 = call i1 @binary_search({ i64, [0 x i64] }* %_test_array4239, i64 80, i64 0, i64 99)
  store i1 %_function4240, i1* %_even4241
  %_test_array4243 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_test_array4220
  %_function4244 = call i1 @binary_search({ i64, [0 x i64] }* %_test_array4243, i64 81, i64 0, i64 99)
  store i1 %_function4244, i1* %_odd4245
