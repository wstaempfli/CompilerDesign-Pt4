...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %args) {
  ...
  %_args6175 = alloca { i64, [0 x i8*] }*
  %_x6177 = alloca i64
  store i64 %argc, i64* %_argc6173
  store { i64, [0 x i8*] }* %args, { i64, [0 x i8*] }** %_args6175
  store i64 0, i64* %_x6177
  br label %_while_cond6179
_while_cond6179:
  %_load6182 = load i64, i64* %_x6177
  %_bop6183 = icmp slt i64 %_load6182, 10
  br i1 %_bop6183, label %_while_body6180, label %_while_exit6181
_while_body6180:
  %_load6184 = load i64, i64* %_x6177
  %_bop6185 = add i64 %_load6184, 1
  store i64 %_bop6185, i64* %_x6177
  br label %_while_cond6179
_while_exit6181:
  %_load6187 = load i64, i64* %_x6177
  ret i64 %_load6187
}
