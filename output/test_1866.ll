...
define i64 @partition({ i64, [0 x i64] }* %a, i64 %l, i64 %r) {
  ...
  %_3135 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_a3133, i32 0, i32 1, i64 %_l3134
  %_3136 = load i64, i64* %_3135
  store i64 %_3136, i64* %_pivot3137
...
_while_cond3158:
  ...
  %_3163 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_a3161, i32 0, i32 1, i64 %_i3162
  %_3164 = load i64, i64* %_3163
  %_pivot3165 = load i64, i64* %_pivot3137
  %_bop3166 = icmp sle i64 %_3164, %_pivot3165
...
_while_cond3177:
  ...
  %_3182 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_a3180, i32 0, i32 1, i64 %_j3181
  %_3183 = load i64, i64* %_3182
  %_pivot3184 = load i64, i64* %_pivot3137
  %_bop3185 = icmp sgt i64 %_3183, %_pivot3184
...
_then3196:
  ...
  %_3203 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_a3201, i32 0, i32 1, i64 %_i3202
  %_3204 = load i64, i64* %_3203
  store i64 %_3204, i64* %_t3146
  %_a3206 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_a3127
  %_j3207 = load i64, i64* %_j3144
  %_3208 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_a3206, i32 0, i32 1, i64 %_j3207
...
_while_exit3152:
  ...
  %_3221 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_a3219, i32 0, i32 1, i64 %_l3220
  %_3222 = load i64, i64* %_3221
  store i64 %_3222, i64* %_t3146
  %_a3224 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_a3127
  %_j3225 = load i64, i64* %_j3144
  %_3226 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_a3224, i32 0, i32 1, i64 %_j3225
