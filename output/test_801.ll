...
_while_body6107:
  ...
  %_gep6126 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_maxarr6124, i32 0, i32 1, i64 %_i6125
  %_load6127 = load i64, i64* %_gep6126
  %_maxarr6128 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_maxarr6086
  %_j6129 = load i64, i64* %_j6104
  %_gep6130 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_maxarr6128, i32 0, i32 1, i64 %_j6129
  %_load6131 = load i64, i64* %_gep6130
  %_arr6132 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_arr6079
  %_i6133 = load i64, i64* %_i6096
  %_gep6134 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_arr6132, i32 0, i32 1, i64 %_i6133
...
_then6112:
  store i64 %_bop6147, i64* %_elem_ptr6150
  %_elem_ptr6150 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_maxarr6148, i32 0, i32 1, i64 %_i6149
  %_maxarr6139 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_maxarr6086
  %_j6140 = load i64, i64* %_j6104
  %_gep6141 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_maxarr6139, i32 0, i32 1, i64 %_j6140
  %_load6142 = load i64, i64* %_gep6141
  %_arr6143 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_arr6079
  %_i6144 = load i64, i64* %_i6096
  %_gep6145 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_arr6143, i32 0, i32 1, i64 %_i6144
...
_then6155:
  ...
  %_gep6166 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_maxarr6164, i32 0, i32 1, i64 %_i6165
