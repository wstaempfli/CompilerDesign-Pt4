...
_for_body5392:
  ...
  %_gep5402 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_ar15400, i32 0, i32 1, i64 %_i5401
  %_load5403 = load i64, i64* %_gep5402
  %_ar25404 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_ar25382
  %_i5405 = load i64, i64* %_i5389
  %_gep5406 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_ar25404, i32 0, i32 1, i64 %_i5405
...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  %_function5377 = call i64 @arrcheck({ i64, [0 x i64] }* %_arr15375, { i64, [0 x i64] }* %_arr25376, i64 4)
  %_bop5378 = icmp eq i64 %_function5377, 1
