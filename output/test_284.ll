...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  store i64 111, i64* %_gep2878
  %_gep2878 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_array2877, i32 0, i32 1, i32 0
  store i64 112, i64* %_gep2880
  %_gep2880 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_array2877, i32 0, i32 1, i32 1
  store i64 113, i64* %_gep2882
  %_gep2882 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_array2877, i32 0, i32 1, i32 2
  store i64 114, i64* %_gep2884
  %_gep2884 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_array2877, i32 0, i32 1, i32 3
  store i64 115, i64* %_gep2886
  %_gep2886 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_array2877, i32 0, i32 1, i32 4
...
_for_body2903:
  ...
  %_load2911 = load i64, i64* %_gep_ptr2910
  %_gep_ptr2910 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_arr22908, i32 0, i32 1, i64 %_i2909
