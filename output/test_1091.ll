...
define { i64, [0 x i64] }* @f({ i64, [0 x i64] }* %x, { i64, [0 x i64] }* %y, i1 %b) {
  ...
  %_y456 = alloca { i64, [0 x i64] }*
  %_b458 = alloca i1
  store { i64, [0 x i64] }* %x, { i64, [0 x i64] }** %_x454
  store { i64, [0 x i64] }* %y, { i64, [0 x i64] }** %_y456
  store i1 %b, i1* %_b458
  %_load463 = load i1, i1* %_b458
  br i1 %_load463, label %_then460, label %_else461
_then460:
  %_load464 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_x454
  ret { i64, [0 x i64] }* %_load464
_else461:
  %_load465 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_y456
  ret { i64, [0 x i64] }* %_load465
}
...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  %_load434 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** @y
  %_load433 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** @x
  %_call435 = call { i64, [0 x i64] }* @f({ i64, [0 x i64] }* %_load433, { i64, [0 x i64] }* %_load434, i1 1)
  %_gep436 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_call435, i32 0, i32 1, i32 0
  store i64 17, i64* %_gep436
  %_load439 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** @y
  %_load438 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** @x
  %_call440 = call { i64, [0 x i64] }* @f({ i64, [0 x i64] }* %_load438, { i64, [0 x i64] }* %_load439, i1 1)
  %_gep441 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_call440, i32 0, i32 1, i32 0
  %_load442 = load i64, i64* %_gep441
  %_load444 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** @x
  %_load443 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** @y
  %_call445 = call { i64, [0 x i64] }* @f({ i64, [0 x i64] }* %_load443, { i64, [0 x i64] }* %_load444, i1 0)
