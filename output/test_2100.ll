...
define i64 @maxsum({ i64, [0 x i64] }* %arr, i64 %size) {
  ...
  %_elem_addr6091 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_arr6090, i32 0, i32 1, i32 0
  %_read_val6092 = load i64, i64* %_elem_addr6091
  ...
  store i64 %_read_val6092, i64* %_gep6094
...
_for_body6107:
  ...
  %_elem_addr6117 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_arr6115, i32 0, i32 1, i64 %_i6116
  %_read_val6118 = load i64, i64* %_elem_addr6117
  %_arr6119 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_arr6079
  %_j6120 = load i64, i64* %_j6104
  %_elem_addr6121 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_arr6119, i32 0, i32 1, i64 %_j6120
  %_read_val6122 = load i64, i64* %_elem_addr6121
  %_bop6123 = icmp sgt i64 %_read_val6118, %_read_val6122
  %_maxarr6124 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_maxarr6086
  %_i6125 = load i64, i64* %_i6096
  %_elem_addr6126 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_maxarr6124, i32 0, i32 1, i64 %_i6125
  %_read_val6127 = load i64, i64* %_elem_addr6126
  %_maxarr6128 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_maxarr6086
  %_j6129 = load i64, i64* %_j6104
  %_elem_addr6130 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_maxarr6128, i32 0, i32 1, i64 %_j6129
  %_read_val6131 = load i64, i64* %_elem_addr6130
  %_arr6132 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_arr6079
  %_i6133 = load i64, i64* %_i6096
  %_elem_addr6134 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_arr6132, i32 0, i32 1, i64 %_i6133
  %_read_val6135 = load i64, i64* %_elem_addr6134
  %_bop6136 = add i64 %_read_val6131, %_read_val6135
  %_bop6137 = icmp slt i64 %_read_val6127, %_bop6136
...
_then6112:
  ...
  %_elem_addr6141 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_maxarr6139, i32 0, i32 1, i64 %_j6140
  %_read_val6142 = load i64, i64* %_elem_addr6141
  %_arr6143 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_arr6079
  %_i6144 = load i64, i64* %_i6096
  %_elem_addr6145 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_arr6143, i32 0, i32 1, i64 %_i6144
  %_read_val6146 = load i64, i64* %_elem_addr6145
  %_bop6147 = add i64 %_read_val6142, %_read_val6146
...
_for_exit6108:
  ...
  %_elem_addr6161 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_maxarr6159, i32 0, i32 1, i64 %_i6160
  %_read_val6162 = load i64, i64* %_elem_addr6161
  %_bop6163 = icmp slt i64 %_maxs6158, %_read_val6162
...
_then6155:
  ...
  %_elem_addr6166 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_maxarr6164, i32 0, i32 1, i64 %_i6165
  %_read_val6167 = load i64, i64* %_elem_addr6166
  store i64 %_read_val6167, i64* %_maxs6088
  br label %_join6157
_else6156:
  br label %_join6157
_join6157:
