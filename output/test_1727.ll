...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  %_elem_addr1289 = getelementptr { i64, [0 x { i64, [0 x { i64, [0 x i64] }*] }*] }, { i64, [0 x { i64, [0 x { i64, [0 x i64] }*] }*] }* %_arr1288, i32 0, i32 1, i32 2
  %_read_val1290 = load { i64, [0 x { i64, [0 x i64] }*] }*, { i64, [0 x { i64, [0 x i64] }*] }** %_elem_addr1289
  %_elem_addr1291 = getelementptr { i64, [0 x { i64, [0 x i64] }*] }, { i64, [0 x { i64, [0 x i64] }*] }* %_read_val1290, i32 0, i32 1, i32 0
  %_read_val1292 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_elem_addr1291
  %_elem_addr1293 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_read_val1292, i32 0, i32 1, i32 1
  %_read_val1294 = load i64, i64* %_elem_addr1293
  ret i64 %_read_val1294
}
