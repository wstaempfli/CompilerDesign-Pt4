...
_then3246:
  ...
  %_call3255 = call i64 @partition({ i64, [0 x i64] }* %_a3252, i64 %_l3253, i64 %_r3254)
...
define i64 @partition({ i64, [0 x i64] }* %a, i64 %l, i64 %r) {
  ...
  %_load3136 = load i64, i64* %_gep_ptr3135
  %_gep_ptr3135 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_a3133, i32 0, i32 1, i64 %_l3134
...
_while_cond3158:
  ...
  %_load3164 = load i64, i64* %_gep_ptr3163
  %_gep_ptr3163 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_a3161, i32 0, i32 1, i64 %_i3162
...
_while_cond3177:
  ...
  %_load3183 = load i64, i64* %_gep_ptr3182
  %_gep_ptr3182 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_a3180, i32 0, i32 1, i64 %_j3181
...
_then3196:
  ...
  %_load3204 = load i64, i64* %_gep_ptr3203
  %_gep_ptr3203 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_a3201, i32 0, i32 1, i64 %_i3202
  store i64 %_load3204, i64* %_t3146
  %_a3206 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_a3127
  %_j3207 = load i64, i64* %_j3144
  %_load3209 = load i64, i64* %_gep_ptr3208
  %_gep_ptr3208 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_a3206, i32 0, i32 1, i64 %_j3207
...
_while_exit3152:
  ...
  %_load3222 = load i64, i64* %_gep_ptr3221
  %_gep_ptr3221 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_a3219, i32 0, i32 1, i64 %_l3220
  store i64 %_load3222, i64* %_t3146
  %_a3224 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_a3127
  %_j3225 = load i64, i64* %_j3144
  %_load3227 = load i64, i64* %_gep_ptr3226
  %_gep_ptr3226 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_a3224, i32 0, i32 1, i64 %_j3225
...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  store i64 107, i64* %_gep3099
  %_gep3099 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_array3098, i32 0, i32 1, i32 0
  store i64 112, i64* %_gep3101
  %_gep3101 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_array3098, i32 0, i32 1, i32 1
  store i64 121, i64* %_gep3103
  %_gep3103 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_array3098, i32 0, i32 1, i32 2
  store i64 102, i64* %_gep3105
  %_gep3105 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_array3098, i32 0, i32 1, i32 3
  store i64 123, i64* %_gep3107
  %_gep3107 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_array3098, i32 0, i32 1, i32 4
  store i64 115, i64* %_gep3109
  %_gep3109 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_array3098, i32 0, i32 1, i32 5
  store i64 104, i64* %_gep3111
  %_gep3111 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_array3098, i32 0, i32 1, i32 6
  store i64 111, i64* %_gep3113
  %_gep3113 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_array3098, i32 0, i32 1, i32 7
  store i64 109, i64* %_gep3115
  %_gep3115 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_array3098, i32 0, i32 1, i32 8
  store { i64, [0 x i64] }* %_array3098, { i64, [0 x i64] }** %_a3117
  %_a3119 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_a3117
  %_call3120 = call i8* @string_of_array({ i64, [0 x i64] }* %_a3119)
  ...
  %_call3125 = call i8* @string_of_array({ i64, [0 x i64] }* %_a3124)
