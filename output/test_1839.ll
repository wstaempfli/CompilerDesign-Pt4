...
define i64 @f({ i64, [0 x i64] }* %a) {
  ...
  %_1601 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_a1600, i32 0, i32 1, i32 1
...
_for_exit1584:
  ...
  %_1596 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_arr1595, i32 0, i32 1, i32 1
...
_for_exit1550:
  ...
  %_1563 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_arr1562, i32 0, i32 1, i32 3
  %_1564 = load i64, i64* %_1563
  %_a1565 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_a1504
  %_1566 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_a1565, i32 0, i32 1, i32 1
  %_1567 = load i64, i64* %_1566
  %_bop1568 = add i64 %_1564, %_1567
