...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  %_function2891 = call i8* @string_of_array({ i64, [0 x i64] }* %_arr12890)
  store i8* %_function2891, i8** %_str2892
  %_str2894 = load i8*, i8** %_str2892
  %_function2895 = call { i64, [0 x i64] }* @array_of_string(i8* %_str2894)
  store { i64, [0 x i64] }* %_function2895, { i64, [0 x i64] }** %_arr22896
