...
_for_body5216:
  ...
  %_5223 = getelementptr { i64, [0 x i1] }, { i64, [0 x i1] }* %_lfsr_register5221, i32 0, i32 1, i64 %_i5222
  %_5224 = load i1, i1* %_5223
  %_funcall5225 = call i8* @string_of_bool(i1 %_5224)
...
_for_body5135:
  ...
  %_5142 = getelementptr { i64, [0 x i1] }, { i64, [0 x i1] }* %_lfsr_init_values5140, i32 0, i32 1, i64 %_i5141
  %_5143 = load i1, i1* %_5142
...
_for_body5154:
  ...
  %_5167 = getelementptr { i64, [0 x i1] }, { i64, [0 x i1] }* %_lfsr_register5164, i32 0, i32 1, i64 %_bop5166
  %_5168 = load i1, i1* %_5167
  ...
  %_5162 = getelementptr { i64, [0 x i1] }, { i64, [0 x i1] }* %_lfsr_register5159, i32 0, i32 1, i64 %_bop5161
  %_5163 = load i1, i1* %_5162
  %_funcall5169 = call i1 @xor(i1 %_5163, i1 %_5168)
...
_for_body5177:
  ...
  %_5184 = getelementptr { i64, [0 x i1] }, { i64, [0 x i1] }* %_lfsr_register5181, i32 0, i32 1, i64 %_bop5183
  %_5185 = load i1, i1* %_5184
