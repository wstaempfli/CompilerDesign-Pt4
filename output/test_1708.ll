...
_for_body707:
  ...
  %_elem_addr714 = getelementptr { i64, [0 x { i64, [0 x i64] }*] }, { i64, [0 x { i64, [0 x i64] }*] }* %_a712, i32 0, i32 1, i64 %_i713
  %_read_val715 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_elem_addr714
  %_j716 = load i64, i64* %_j704
  %_elem_addr717 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_read_val715, i32 0, i32 1, i64 %_j716
  %_read_val718 = load i64, i64* %_elem_addr717
  %_bop719 = add i64 %_s711, %_read_val718
