...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  store i64 1, i64* %_gep1182
  %_gep1182 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_array1181, i32 0, i32 1, i32 0
  store i64 2, i64* %_gep1184
  %_gep1184 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_array1181, i32 0, i32 1, i32 1
  store { i64, [0 x i64] }* %_array1181, { i64, [0 x i64] }** %_gep1186
  %_gep1186 = getelementptr { i64, [0 x { i64, [0 x i64] }*] }, { i64, [0 x { i64, [0 x i64] }*] }* %_array1179, i32 0, i32 1, i32 0
  %_raw_array1188 = call i64* @oat_alloc_array(i64 2)
  %_array1189 = bitcast i64* %_raw_array1188 to { i64, [0 x i64] }*
  store i64 3, i64* %_gep1190
  %_gep1190 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_array1189, i32 0, i32 1, i32 0
  store i64 4, i64* %_gep1192
  %_gep1192 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_array1189, i32 0, i32 1, i32 1
  store { i64, [0 x i64] }* %_array1189, { i64, [0 x i64] }** %_gep1194
  %_gep1194 = getelementptr { i64, [0 x { i64, [0 x i64] }*] }, { i64, [0 x { i64, [0 x i64] }*] }* %_array1179, i32 0, i32 1, i32 1
  store { i64, [0 x { i64, [0 x i64] }*] }* %_array1179, { i64, [0 x { i64, [0 x i64] }*] }** @arr
  %_arr1197 = load { i64, [0 x { i64, [0 x i64] }*] }*, { i64, [0 x { i64, [0 x i64] }*] }** @arr
  %_load1199 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_gep_ptr1198
  %_gep_ptr1198 = getelementptr { i64, [0 x { i64, [0 x i64] }*] }, { i64, [0 x { i64, [0 x i64] }*] }* %_arr1197, i32 0, i32 1, i32 1
  %_load1201 = load i64, i64* %_gep_ptr1200
  %_gep_ptr1200 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_load1199, i32 0, i32 1, i32 1
  ret i64 %_load1201
}
