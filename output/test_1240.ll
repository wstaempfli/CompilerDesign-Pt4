...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  %_argv7932 = alloca { i64, [0 x i8*] }*
  %_x7935 = alloca i64
  store i64 %argc, i64* %_argc7930
  store { i64, [0 x i8*] }* %argv, { i64, [0 x i8*] }** %_argv7932
  %_call7934 = call i64 @abs2()
  store i64 %_call7934, i64* %_x7935
  %_load7937 = load i64, i64* %_x7935
  %_call7938 = call i64 @abs()
  %_bop7939 = add i64 %_load7937, %_call7938
  store i64 %_bop7939, i64* %_x7935
  %_load7941 = load i64, i64* %_x7935
  ret i64 %_load7941
}
