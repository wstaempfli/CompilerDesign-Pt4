...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  %_call2766 = call { i64, [0 x i64] }* @array_of_string(i8* %_str2765)
...
_for_body2774:
  ...
  %_load2782 = load i64, i64* %_gep_ptr2781
  %_gep_ptr2781 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_arr2779, i32 0, i32 1, i64 %_i2780
