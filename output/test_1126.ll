...
define i64 @f({ i64, [0 x i64] }* %arr) {
  ...
  %_load1495 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_arr1493
  %_gep1496 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_load1495, i32 0, i32 1, i32 3
...
define { i64, [0 x i64] }* @g() {
  ...
  %_load1492 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_arr1490
  ret { i64, [0 x i64] }* %_load1492
}

define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  %_argc1379 = alloca i64
  %_argv1381 = alloca { i64, [0 x i8*] }*
  ...
  store { i64, [0 x i8*] }* %argv, { i64, [0 x i8*] }** %_argv1381
  ...
  %_load1444 = load i64, i64* %_c1427
  %_load1445 = load i64, i64* @i
  %_bop1446 = add i64 %_load1444, %_load1445
  store i64 %_bop1446, i64* %_c1427
  %_load1448 = load i64, i64* %_c1427
  %_load1449 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_arr11391
  %_gep1450 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_load1449, i32 0, i32 1, i32 1
  %_load1451 = load i64, i64* %_gep1450
  %_bop1452 = add i64 %_load1448, %_load1451
  store i64 %_bop1452, i64* %_c1427
  %_load1454 = load i64, i64* %_c1427
  %_load1455 = load { i64, [0 x { i64, [0 x i64] }*] }*, { i64, [0 x { i64, [0 x i64] }*] }** %_arr21425
  %_gep1456 = getelementptr { i64, [0 x { i64, [0 x i64] }*] }, { i64, [0 x { i64, [0 x i64] }*] }* %_load1455, i32 0, i32 1, i32 1
  ...
  %_bop1460 = add i64 %_load1454, %_load1459
  store i64 %_bop1460, i64* %_c1427
  %_load1462 = load i64, i64* %_c1427
  %_load1463 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_arr31442
  %_gep1464 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_load1463, i32 0, i32 1, i32 3
  %_load1465 = load i64, i64* %_gep1464
  %_bop1466 = add i64 %_load1462, %_load1465
  store i64 %_bop1466, i64* %_c1427
  %_load1468 = load i64, i64* %_c1427
  %_load1469 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_arr31442
  %_call1470 = call i64 @f({ i64, [0 x i64] }* %_load1469)
  %_bop1471 = add i64 %_load1468, %_call1470
  store i64 %_bop1471, i64* %_c1427
  %_load1473 = load i64, i64* %_c1427
  %_load1474 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_arr41430
  %_gep1475 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_load1474, i32 0, i32 1, i32 1
  %_load1476 = load i64, i64* %_gep1475
  %_bop1477 = add i64 %_load1473, %_load1476
  store i64 %_bop1477, i64* %_c1427
  %_load1479 = load i64, i64* %_c1427
  ret i64 %_load1479
}
