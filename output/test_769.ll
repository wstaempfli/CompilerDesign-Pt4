...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  store i64 %_call2722, i64* %_elem_ptr2724
  %_elem_ptr2724 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_b2723, i32 0, i32 1, i32 0
  %_call2722 = call i64 @f()
  %_b2723 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_b2720
  store i64 %_call2726, i64* %_elem_ptr2728
  %_elem_ptr2728 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_b2727, i32 0, i32 1, i32 1
  ...
  %_gep2732 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_b2731, i32 0, i32 1, i32 0
  %_load2733 = load i64, i64* %_gep2732
  %_bop2734 = add i64 %_a2730, %_load2733
  %_b2735 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_b2720
  %_gep2736 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_b2735, i32 0, i32 1, i32 1
