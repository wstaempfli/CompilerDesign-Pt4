...
define i64 @min({ i64, [0 x i64] }* %arr, i64 %len) {
  ...
  %_elem_addr4742 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_arr4741, i32 0, i32 1, i32 0
  %_read_val4743 = load i64, i64* %_elem_addr4742
  store i64 %_read_val4743, i64* %_min4744
...
_for_body4749:
  ...
  %_elem_addr4759 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_arr4757, i32 0, i32 1, i64 %_i4758
  %_read_val4760 = load i64, i64* %_elem_addr4759
  %_min4761 = load i64, i64* %_min4744
  %_bop4762 = icmp slt i64 %_read_val4760, %_min4761
  br i1 %_bop4762, label %_then4754, label %_else4755
_then4754:
  %_arr4763 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_arr4737
  %_i4764 = load i64, i64* %_i4746
  %_elem_addr4765 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_arr4763, i32 0, i32 1, i64 %_i4764
  %_read_val4766 = load i64, i64* %_elem_addr4765
  store i64 %_read_val4766, i64* %_min4744
  br label %_join4756
_else4755:
  br label %_join4756
_join4756:
...
define i64 @max({ i64, [0 x i64] }* %arr, i64 %len) {
  ...
  %_elem_addr4707 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_arr4706, i32 0, i32 1, i32 0
  %_read_val4708 = load i64, i64* %_elem_addr4707
  store i64 %_read_val4708, i64* %_max4709
...
_for_body4714:
  ...
  %_elem_addr4724 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_arr4722, i32 0, i32 1, i64 %_i4723
  %_read_val4725 = load i64, i64* %_elem_addr4724
  %_max4726 = load i64, i64* %_max4709
  %_bop4727 = icmp sgt i64 %_read_val4725, %_max4726
  br i1 %_bop4727, label %_then4719, label %_else4720
_then4719:
  %_arr4728 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_arr4702
  %_i4729 = load i64, i64* %_i4711
  %_elem_addr4730 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_arr4728, i32 0, i32 1, i64 %_i4729
  %_read_val4731 = load i64, i64* %_elem_addr4730
  store i64 %_read_val4731, i64* %_max4709
  br label %_join4721
_else4720:
  br label %_join4721
_join4721:
...
_for_body4624:
  ...
  %_elem_addr4632 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_arr4630, i32 0, i32 1, i64 %_i4631
  %_read_val4633 = load i64, i64* %_elem_addr4632
  %_min4634 = load i64, i64* %_min4606
  %_bop4635 = sub i64 %_read_val4633, %_min4634
  %_elem_addr4636 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_counts4629, i32 0, i32 1, i64 %_bop4635
  %_read_val4637 = load i64, i64* %_elem_addr4636
  %_bop4638 = add i64 %_read_val4637, 1
  ...
  %_elem_addr4642 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_arr4640, i32 0, i32 1, i64 %_i4641
  %_read_val4643 = load i64, i64* %_elem_addr4642
  %_min4644 = load i64, i64* %_min4606
  %_bop4645 = sub i64 %_read_val4643, %_min4644
...
_while_body4662:
  ...
  %_elem_addr4674 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_counts4670, i32 0, i32 1, i64 %_bop4673
  %_read_val4675 = load i64, i64* %_elem_addr4674
  %_bop4676 = icmp sgt i64 %_read_val4675, 0
...
_then4667:
  ...
  %_elem_addr4686 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_counts4682, i32 0, i32 1, i64 %_bop4685
  %_read_val4687 = load i64, i64* %_elem_addr4686
  %_bop4688 = sub i64 %_read_val4687, 1
