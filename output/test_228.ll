...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  %_load442 = load i64, i64* %_gep_ptr441
  %_gep_ptr441 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_call440, i32 0, i32 1, i32 0
  ...
  %_load447 = load i64, i64* %_gep_ptr446
  %_gep_ptr446 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_call445, i32 0, i32 1, i32 0
