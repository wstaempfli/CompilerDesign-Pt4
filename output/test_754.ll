...
define i64 @g(i64 %x) {
  ...
  br label %_while_cond1582
_while_cond1582:
  %_i1585 = load i64, i64* %_i1580
  %_bop1586 = icmp slt i64 %_i1585, 3
  br i1 %_bop1586, label %_while_body1583, label %_while_end1584
_while_body1583:
  store i64 %_x1587, i64* %_elem_ptr1590
  %_elem_ptr1590 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_arr1588, i32 0, i32 1, i64 %_i1589
...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  br label %_while_cond1508
_while_cond1508:
  %_i1511 = load i64, i64* %_i1506
  %_bop1512 = icmp slt i64 %_i1511, 3
  br i1 %_bop1512, label %_while_body1509, label %_while_end1510
_while_body1509:
  store i64 %_i1513, i64* %_elem_ptr1516
  %_elem_ptr1516 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_a1514, i32 0, i32 1, i64 %_i1515
...
_while_end1510:
  ...
  br label %_while_cond1527
_while_cond1527:
  %_i1530 = load i64, i64* %_i1525
  %_bop1531 = icmp slt i64 %_i1530, 4
  br i1 %_bop1531, label %_while_body1528, label %_while_end1529
_while_body1528:
  store i64 %_bop1534, i64* %_elem_ptr1537
  %_elem_ptr1537 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_arr1535, i32 0, i32 1, i64 %_i1536
...
_while_end1529:
  ...
  br label %_while_cond1548
_while_cond1548:
  %_i1551 = load i64, i64* %_i1546
  %_bop1552 = icmp slt i64 %_i1551, 3
  br i1 %_bop1552, label %_while_body1549, label %_while_end1550
_while_body1549:
  store i64 %_bop1554, i64* %_elem_ptr1557
  %_elem_ptr1557 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_arr01555, i32 0, i32 1, i64 %_i1556
