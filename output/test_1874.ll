...
_for_body4500:
  ...
  %_4510 = getelementptr { i64, [0 x i1] }, { i64, [0 x i1] }* %_arr4508, i32 0, i32 1, i64 %_i4509
  %_4511 = load i1, i1* %_4510
  br i1 %_4511, label %_then4505, label %_else4506
_then4505:
...
_for_body4538:
  ...
  %_4548 = getelementptr { i64, [0 x i1] }, { i64, [0 x i1] }* %_arr4546, i32 0, i32 1, i64 %_i4547
  %_4549 = load i1, i1* %_4548
  br i1 %_4549, label %_then4543, label %_else4544
_then4543:
