...
_for_body4063:
  ...
  %_elem_addr4069 = getelementptr { i64, [0 x { i64, [0 x i64] }*] }, { i64, [0 x { i64, [0 x i64] }*] }* %_a34067, i32 0, i32 1, i64 %_i4068
  %_read_val4070 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_elem_addr4069
  %_j4071 = load i64, i64* %_j4053
  %_elem_addr4072 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_read_val4070, i32 0, i32 1, i64 %_j4071
  %_read_val4073 = load i64, i64* %_elem_addr4072
  %_a14074 = load { i64, [0 x { i64, [0 x i64] }*] }*, { i64, [0 x { i64, [0 x i64] }*] }** %_a14040
  %_i4075 = load i64, i64* %_i4046
  %_elem_addr4076 = getelementptr { i64, [0 x { i64, [0 x i64] }*] }, { i64, [0 x { i64, [0 x i64] }*] }* %_a14074, i32 0, i32 1, i64 %_i4075
  %_read_val4077 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_elem_addr4076
  %_k4078 = load i64, i64* %_k4060
  %_elem_addr4079 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_read_val4077, i32 0, i32 1, i64 %_k4078
  %_read_val4080 = load i64, i64* %_elem_addr4079
  %_a24081 = load { i64, [0 x { i64, [0 x i64] }*] }*, { i64, [0 x { i64, [0 x i64] }*] }** %_a24041
  %_k4082 = load i64, i64* %_k4060
  %_elem_addr4083 = getelementptr { i64, [0 x { i64, [0 x i64] }*] }, { i64, [0 x { i64, [0 x i64] }*] }* %_a24081, i32 0, i32 1, i64 %_k4082
  %_read_val4084 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_elem_addr4083
  %_j4085 = load i64, i64* %_j4053
  %_elem_addr4086 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_read_val4084, i32 0, i32 1, i64 %_j4085
  %_read_val4087 = load i64, i64* %_elem_addr4086
  %_bop4088 = mul i64 %_read_val4080, %_read_val4087
  %_bop4089 = add i64 %_read_val4073, %_bop4088
  %_a34090 = load { i64, [0 x { i64, [0 x i64] }*] }*, { i64, [0 x { i64, [0 x i64] }*] }** %_a34042
  %_i4091 = load i64, i64* %_i4046
  %_elem_addr4092 = getelementptr { i64, [0 x { i64, [0 x i64] }*] }, { i64, [0 x { i64, [0 x i64] }*] }* %_a34090, i32 0, i32 1, i64 %_i4091
  %_read_val4093 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_elem_addr4092
  %_j4094 = load i64, i64* %_j4053
  %_gep4095 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_read_val4093, i32 0, i32 1, i64 %_j4094
...
_for_body4018:
  ...
  %_funcall4026 = call i64 @dot3({ i64, [0 x { i64, [0 x i64] }*] }* %_a14022, { i64, [0 x { i64, [0 x i64] }*] }* %_a24023, i64 %_i4024, i64 %_j4025)
  %_a34027 = load { i64, [0 x { i64, [0 x i64] }*] }*, { i64, [0 x { i64, [0 x i64] }*] }** %_a34004
  %_i4028 = load i64, i64* %_i4008
  %_elem_addr4029 = getelementptr { i64, [0 x { i64, [0 x i64] }*] }, { i64, [0 x { i64, [0 x i64] }*] }* %_a34027, i32 0, i32 1, i64 %_i4028
  %_read_val4030 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_elem_addr4029
  %_j4031 = load i64, i64* %_j4015
  %_gep4032 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_read_val4030, i32 0, i32 1, i64 %_j4031
  store i64 %_funcall4026, i64* %_gep4032
...
_for_body3976:
  ...
  %_elem_addr3983 = getelementptr { i64, [0 x { i64, [0 x i64] }*] }, { i64, [0 x { i64, [0 x i64] }*] }* %_a13981, i32 0, i32 1, i64 %_row3982
  %_read_val3984 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_elem_addr3983
  %_k3985 = load i64, i64* %_k3973
  %_elem_addr3986 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_read_val3984, i32 0, i32 1, i64 %_k3985
  %_read_val3987 = load i64, i64* %_elem_addr3986
  %_a23988 = load { i64, [0 x { i64, [0 x i64] }*] }*, { i64, [0 x { i64, [0 x i64] }*] }** %_a23964
  %_k3989 = load i64, i64* %_k3973
  %_elem_addr3990 = getelementptr { i64, [0 x { i64, [0 x i64] }*] }, { i64, [0 x { i64, [0 x i64] }*] }* %_a23988, i32 0, i32 1, i64 %_k3989
  %_read_val3991 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_elem_addr3990
  %_col3992 = load i64, i64* %_col3966
  %_elem_addr3993 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_read_val3991, i32 0, i32 1, i64 %_col3992
  %_read_val3994 = load i64, i64* %_elem_addr3993
  %_bop3995 = mul i64 %_read_val3987, %_read_val3994
...
_for_body3939:
  ...
  %_elem_addr3945 = getelementptr { i64, [0 x { i64, [0 x i64] }*] }, { i64, [0 x { i64, [0 x i64] }*] }* %_ar3943, i32 0, i32 1, i64 %_i3944
  %_read_val3946 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_elem_addr3945
  %_j3947 = load i64, i64* %_j3936
  %_elem_addr3948 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_read_val3946, i32 0, i32 1, i64 %_j3947
  %_read_val3949 = load i64, i64* %_elem_addr3948
  call void @print_int(i64 %_read_val3949)
  %_str3952 = bitcast [2 x i8]* @_str3951 to i8*
  call void @print_string(i8* %_str3952)
  %_j3954 = load i64, i64* %_j3936
  %_bop3955 = add i64 %_j3954, 1
  store i64 %_bop3955, i64* %_j3936
  br label %_for_cond3938
_for_exit3940:
  %_str3958 = bitcast [2 x i8]* @_str3957 to i8*
  call void @print_string(i8* %_str3958)
