...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  store i64 %argc, i64* %_argc538
  store { i64, [0 x i8*] }* %argv, { i64, [0 x i8*] }** %_argv539
  %_function542 = call i64 @f()
  %_function543 = call i64 @g()
  %_bop544 = add i64 %_function542, %_function543
