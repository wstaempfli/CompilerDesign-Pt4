...
define i64 @sieve(i64 %n) {
  ...
  br label %_while_cond4478
_while_cond4478:
  %_i4481 = load i64, i64* %_i4476
  %_n4482 = load i64, i64* %_n4469
  %_bop4483 = icmp slt i64 %_i4481, %_n4482
  br i1 %_bop4483, label %_while_body4479, label %_while_end4480
_while_body4479:
  store i1 1, i1* %_elem_ptr4486
  %_elem_ptr4486 = getelementptr { i64, [0 x i1] }, { i64, [0 x i1] }* %_arr4484, i32 0, i32 1, i64 %_i4485
  ...
  br label %_while_end4480
_while_end4480:
  store i1 0, i1* %_elem_ptr4492
  %_elem_ptr4492 = getelementptr { i64, [0 x i1] }, { i64, [0 x i1] }* %_arr4491, i32 0, i32 1, i32 0
  %_arr4491 = load { i64, [0 x i1] }*, { i64, [0 x i1] }** %_arr4474
  store i1 0, i1* %_elem_ptr4495
  %_elem_ptr4495 = getelementptr { i64, [0 x i1] }, { i64, [0 x i1] }* %_arr4494, i32 0, i32 1, i32 1
  %_arr4494 = load { i64, [0 x i1] }*, { i64, [0 x i1] }** %_arr4474
  store i64 0, i64* %_i4497
  br label %_while_cond4499
_while_cond4499:
  %_i4502 = load i64, i64* %_i4497
  %_n4503 = load i64, i64* %_n4469
  %_bop4504 = icmp slt i64 %_i4502, %_n4503
  br i1 %_bop4504, label %_while_body4500, label %_while_end4501
_while_body4500:
...
_then4505:
  ...
  br label %_while_cond4516
_while_cond4516:
  %_j4519 = load i64, i64* %_j4514
  %_n4520 = load i64, i64* %_n4469
  %_bop4521 = icmp slt i64 %_j4519, %_n4520
  br i1 %_bop4521, label %_while_body4517, label %_while_end4518
_while_body4517:
  store i1 0, i1* %_elem_ptr4524
  %_elem_ptr4524 = getelementptr { i64, [0 x i1] }, { i64, [0 x i1] }* %_arr4522, i32 0, i32 1, i64 %_j4523
...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  %_call4468 = call i64 @sieve(i64 %_n4467)
  ret i64 %_call4468
}
