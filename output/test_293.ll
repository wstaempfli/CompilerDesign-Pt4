...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  store i64 126, i64* %_gep3548
  %_gep3548 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_array3547, i32 0, i32 1, i32 0
  store i64 125, i64* %_gep3550
  %_gep3550 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_array3547, i32 0, i32 1, i32 1
  store i64 124, i64* %_gep3552
  %_gep3552 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_array3547, i32 0, i32 1, i32 2
  store i64 123, i64* %_gep3554
  %_gep3554 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_array3547, i32 0, i32 1, i32 3
  store i64 122, i64* %_gep3556
  %_gep3556 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_array3547, i32 0, i32 1, i32 4
  store i64 121, i64* %_gep3558
  %_gep3558 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_array3547, i32 0, i32 1, i32 5
  store i64 120, i64* %_gep3560
  %_gep3560 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_array3547, i32 0, i32 1, i32 6
  store i64 119, i64* %_gep3562
  %_gep3562 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_array3547, i32 0, i32 1, i32 7
  store i64 118, i64* %_gep3564
  %_gep3564 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_array3547, i32 0, i32 1, i32 8
  store i64 117, i64* %_gep3566
  %_gep3566 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_array3547, i32 0, i32 1, i32 9
...
_while_body3399:
  ...
  %_load3414 = load i64, i64* %_gep_ptr3413
  %_gep_ptr3413 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_a3411, i32 0, i32 1, i64 %_i3412
  %_a3415 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_a3373
  %_j3416 = load i64, i64* %_j3383
  %_load3418 = load i64, i64* %_gep_ptr3417
  %_gep_ptr3417 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_a3415, i32 0, i32 1, i64 %_j3416
...
_then3408:
  ...
  %_load3423 = load i64, i64* %_gep_ptr3422
  %_gep_ptr3422 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_a3420, i32 0, i32 1, i64 %_i3421
...
_else3409:
  ...
  %_load3437 = load i64, i64* %_gep_ptr3436
  %_gep_ptr3436 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_a3434, i32 0, i32 1, i64 %_j3435
...
_while_body3449:
  ...
  %_load3457 = load i64, i64* %_gep_ptr3456
  %_gep_ptr3456 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_a3454, i32 0, i32 1, i64 %_i3455
...
_while_body3469:
  ...
  %_load3477 = load i64, i64* %_gep_ptr3476
  %_gep_ptr3476 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_a3474, i32 0, i32 1, i64 %_j3475
...
_for_body3491:
  ...
  %_load3499 = load i64, i64* %_gep_ptr3498
  %_gep_ptr3498 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_c3496, i32 0, i32 1, i64 %_i3497
