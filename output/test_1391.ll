...
define i64 @f1(i64 %i) {
  ...
  %_function825 = call i64 @f2(i64 %_i824)
  ret i64 %_function825
}
...
define i64 @f2(i64 %i) {
  ...
  %_function821 = call i64 @f3(i64 %_i820)
  ret i64 %_function821
}
...
define i64 @f3(i64 %i) {
  ...
  %_function817 = call i64 @f4(i64 %_i816)
  ret i64 %_function817
}
...
define i64 @f4(i64 %i) {
  ...
  %_function813 = call i64 @f5(i64 %_i812)
  ret i64 %_function813
}
...
define i64 @f5(i64 %i) {
  ...
  %_function809 = call i64 @f6(i64 %_i808)
  ret i64 %_function809
}
...
define i64 @f6(i64 %i) {
  ...
  %_function805 = call i64 @f7(i64 %_i804)
  ret i64 %_function805
}
...
define i64 @f7(i64 %i) {
  ...
  %_function801 = call i64 @f8(i64 %_i800)
  ret i64 %_function801
}
...
define i64 @f8(i64 %i) {
  ...
  %_function797 = call i64 @f9(i64 %_i796)
  ret i64 %_function797
}
...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  %_function790 = call i64 @f1(i64 %_argc789)
  ret i64 %_function790
}
