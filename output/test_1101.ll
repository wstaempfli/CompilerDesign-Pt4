...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  %_argc553 = alloca i64
  %_argv555 = alloca { i64, [0 x i8*] }*
  %_b563 = alloca { i64, [0 x i1] }*
  %_i565 = alloca i64
  store i64 %argc, i64* %_argc553
  store { i64, [0 x i8*] }* %argv, { i64, [0 x i8*] }** %_argv555
  ...
  %_load570 = load { i64, [0 x i1] }*, { i64, [0 x i1] }** %_b563
  %_gep571 = getelementptr { i64, [0 x i1] }, { i64, [0 x i1] }* %_load570, i32 0, i32 1, i32 0
  %_load572 = load i1, i1* %_gep571
