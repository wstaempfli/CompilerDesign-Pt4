...
_then3334:
  ...
  store i64 %_load3356, i64* %_elem_ptr3360
  %_elem_ptr3360 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_numbers3357, i32 0, i32 1, i64 %_bop3359
  ...
  store i64 %_temp3362, i64* %_elem_ptr3365
  %_elem_ptr3365 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_numbers3363, i32 0, i32 1, i64 %_i3364
...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  store i64 121, i64* %_elem_ptr3276
  %_elem_ptr3276 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_a3275, i32 0, i32 1, i32 0
  %_a3275 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_a3273
  store i64 125, i64* %_elem_ptr3279
  %_elem_ptr3279 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_a3278, i32 0, i32 1, i32 1
  %_a3278 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_a3273
  store i64 120, i64* %_elem_ptr3282
  %_elem_ptr3282 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_a3281, i32 0, i32 1, i32 2
  %_a3281 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_a3273
  store i64 111, i64* %_elem_ptr3285
  %_elem_ptr3285 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_a3284, i32 0, i32 1, i32 3
  %_a3284 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_a3273
  store i64 116, i64* %_elem_ptr3288
  %_elem_ptr3288 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_a3287, i32 0, i32 1, i32 4
  %_a3287 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_a3273
  store i64 110, i64* %_elem_ptr3291
  %_elem_ptr3291 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_a3290, i32 0, i32 1, i32 5
  %_a3290 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_a3273
  store i64 117, i64* %_elem_ptr3294
  %_elem_ptr3294 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_a3293, i32 0, i32 1, i32 6
  %_a3293 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_a3273
  store i64 119, i64* %_elem_ptr3297
  %_elem_ptr3297 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_a3296, i32 0, i32 1, i32 7
  %_a3296 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_a3273
  %_a3299 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_a3273
  %_call3300 = call i8* @string_of_array({ i64, [0 x i64] }* %_a3299)
  ...
  %_call3308 = call i8* @string_of_array({ i64, [0 x i64] }* %_a3307)
