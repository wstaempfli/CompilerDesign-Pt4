...
define i64 @f({ i64, [0 x i64] }* %a) {
  ...
  %_load1602 = load i64, i64* %_gep_ptr1601
  %_gep_ptr1601 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_a1600, i32 0, i32 1, i32 1
  ret i64 %_load1602
}
...
_for_exit1584:
  ...
  %_load1597 = load i64, i64* %_gep_ptr1596
  %_gep_ptr1596 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_arr1595, i32 0, i32 1, i32 1
  ret i64 %_load1597
}
...
_for_exit1550:
  ...
  %_load1564 = load i64, i64* %_gep_ptr1563
  %_gep_ptr1563 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_arr1562, i32 0, i32 1, i32 3
  %_a1565 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_a1504
  %_load1567 = load i64, i64* %_gep_ptr1566
  %_gep_ptr1566 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_a1565, i32 0, i32 1, i32 1
