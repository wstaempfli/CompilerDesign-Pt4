...
_then5077:
  ...
  %_funcall5086 = call i64 @binary_gcd(i64 %_bop5084, i64 %_y5085)
  ret i64 %_funcall5086
_else5078:
  %_y5089 = load i64, i64* %_y5048
  %_bop5090 = lshr i64 %_y5089, 1
  %_x5087 = load i64, i64* %_x5047
  %_bop5088 = lshr i64 %_x5087, 1
  %_funcall5091 = call i64 @binary_gcd(i64 %_bop5088, i64 %_bop5090)
  %_bop5092 = shl i64 %_funcall5091, 1
  ret i64 %_bop5092
_join5079:
  br label %_join5072
_else5071:
...
_then5093:
  ...
  %_funcall5103 = call i64 @binary_gcd(i64 %_x5100, i64 %_bop5102)
  ret i64 %_funcall5103
_else5094:
  br label %_join5095
_join5095:
...
_then5104:
  ...
  %_funcall5115 = call i64 @binary_gcd(i64 %_bop5113, i64 %_y5114)
  ret i64 %_funcall5115
_else5105:
  br label %_join5106
_join5106:
  ...
  %_funcall5121 = call i64 @binary_gcd(i64 %_bop5119, i64 %_x5120)
  ret i64 %_funcall5121
}
...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  %_funcall5046 = call i64 @binary_gcd(i64 %_x5044, i64 %_y5045)
  ret i64 %_funcall5046
}
