...
_for_cond699:
  %_load702 = load i64, i64* %_i697
  %_bop703 = icmp slt i64 %_load702, 3
  br i1 %_bop703, label %_for_body700, label %_for_exit701
_for_body700:
  store i64 0, i64* %_j704
  br label %_for_cond706
_for_cond706:
  %_load709 = load i64, i64* %_j704
  %_bop710 = icmp slt i64 %_load709, 4
  br i1 %_bop710, label %_for_body707, label %_for_exit708
_for_body707:
  %_load711 = load i64, i64* %_s695
  %_load712 = load { i64, [0 x { i64, [0 x i64] }*] }*, { i64, [0 x { i64, [0 x i64] }*] }** @a
  %_load713 = load i64, i64* %_i697
  %_gep714 = getelementptr { i64, [0 x { i64, [0 x i64] }*] }, { i64, [0 x { i64, [0 x i64] }*] }* %_load712, i32 0, i32 1, i64 %_load713
  %_load715 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_gep714
  %_load716 = load i64, i64* %_j704
  %_gep717 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_load715, i32 0, i32 1, i64 %_load716
  %_load718 = load i64, i64* %_gep717
  %_bop719 = add i64 %_load711, %_load718
  store i64 %_bop719, i64* %_s695
  %_load721 = load i64, i64* %_j704
  %_bop722 = add i64 %_load721, 1
  store i64 %_bop722, i64* %_j704
  br label %_for_cond706
_for_exit708:
  %_load724 = load i64, i64* %_i697
  %_bop725 = add i64 %_load724, 1
  store i64 %_bop725, i64* %_i697
  br label %_for_cond699
_for_exit701:
  %_load727 = load i64, i64* %_s695
  ret i64 %_load727
}
