...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  %_x7882 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_x7880
  store { i64, [0 x i64] }* %_x7882, { i64, [0 x i64] }** %_arr7876
  %_x7884 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_x7880
  %_gep7885 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_x7884, i32 0, i32 1, i32 2
  store i64 3, i64* %_gep7885
  %_arr7887 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_arr7876
  %_gep7888 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_arr7887, i32 0, i32 1, i32 2
