...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  %_elem_addr1198 = getelementptr { i64, [0 x { i64, [0 x i64] }*] }, { i64, [0 x { i64, [0 x i64] }*] }* %_arr1197, i32 0, i32 1, i32 1
  %_read_val1199 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_elem_addr1198
  %_elem_addr1200 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_read_val1199, i32 0, i32 1, i32 1
  %_read_val1201 = load i64, i64* %_elem_addr1200
  ret i64 %_read_val1201
}
