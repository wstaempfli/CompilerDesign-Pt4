...
define i64 @xor_shift_plus({ i64, [0 x i64] }* %s) {
  ...
  %_elem_addr4412 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_s4411, i32 0, i32 1, i32 0
  %_read_val4413 = load i64, i64* %_elem_addr4412
  store i64 %_read_val4413, i64* %_x4414
  %_s4416 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_s4409
  %_elem_addr4417 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_s4416, i32 0, i32 1, i32 1
  %_read_val4418 = load i64, i64* %_elem_addr4417
  store i64 %_read_val4418, i64* %_y4419
