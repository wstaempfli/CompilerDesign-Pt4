...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  %_funcall2891 = call i8* @string_of_array({ i64, [0 x i64] }* %_arr12890)
  store i8* %_funcall2891, i8** %_str2892
  %_str2894 = load i8*, i8** %_str2892
  %_funcall2895 = call { i64, [0 x i64] }* @array_of_string(i8* %_str2894)
  store { i64, [0 x i64] }* %_funcall2895, { i64, [0 x i64] }** %_arr22896
...
_for_body2903:
  ...
  %_elem_addr2910 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_arr22908, i32 0, i32 1, i64 %_i2909
  %_read_val2911 = load i64, i64* %_elem_addr2910
  %_bop2912 = add i64 %_s2907, %_read_val2911
