...
define i64 @xor_shift_plus({ i64, [0 x i64] }* %s) {
  ...
  %_gep4412 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_s4411, i32 0, i32 1, i32 0
  %_load4413 = load i64, i64* %_gep4412
  store i64 %_load4413, i64* %_x4414
  %_s4416 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_s4409
  %_gep4417 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_s4416, i32 0, i32 1, i32 1
  %_load4418 = load i64, i64* %_gep4417
  store i64 %_load4418, i64* %_y4419
  store i64 %_y4421, i64* %_elem_ptr4423
  %_elem_ptr4423 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_s4422, i32 0, i32 1, i32 0
  ...
  %_call4428 = call i64 @xor(i64 %_x4425, i64 %_bop4427)
  store i64 %_call4428, i64* %_x4414
  %_x4431 = load i64, i64* %_x4414
  %_bop4432 = lshr i64 %_x4431, 17
  %_x4430 = load i64, i64* %_x4414
  %_call4433 = call i64 @xor(i64 %_x4430, i64 %_bop4432)
  store i64 %_call4433, i64* %_x4414
  %_y4437 = load i64, i64* %_y4419
  %_bop4438 = lshr i64 %_y4437, 26
  %_y4436 = load i64, i64* %_y4419
  %_call4439 = call i64 @xor(i64 %_y4436, i64 %_bop4438)
  %_x4435 = load i64, i64* %_x4414
  %_call4440 = call i64 @xor(i64 %_x4435, i64 %_call4439)
  store i64 %_call4440, i64* %_x4414
  store i64 %_x4442, i64* %_elem_ptr4444
  %_elem_ptr4444 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_s4443, i32 0, i32 1, i32 1
...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  br label %_while_cond4385
_while_cond4385:
  %_i4388 = load i64, i64* %_i4383
  %_bop4389 = icmp slt i64 %_i4388, 2
  br i1 %_bop4389, label %_while_body4386, label %_while_end4387
_while_body4386:
  store i64 %_bop4392, i64* %_elem_ptr4395
  %_elem_ptr4395 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_seed4393, i32 0, i32 1, i64 %_i4394
  ...
  br label %_while_end4387
_while_end4387:
  %_seed4400 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_seed4381
  %_call4401 = call i64 @xor_shift_plus({ i64, [0 x i64] }* %_seed4400)
  ...
  %_call4407 = call i64 @xor_shift_plus({ i64, [0 x i64] }* %_seed4406)
