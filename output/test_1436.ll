...
define i8* @sub(i8* %str, i64 %start, i64 %len) {
  ...
  %_function3040 = call { i64, [0 x i64] }* @array_of_string(i8* %_str3039)
  store { i64, [0 x i64] }* %_function3040, { i64, [0 x i64] }** %_arr3041
...
_for_body3051:
  ...
  %_gep3060 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_arr3056, i32 0, i32 1, i64 %_bop3059
...
_for_exit3052:
  ...
  %_function3070 = call i8* @string_of_array({ i64, [0 x i64] }* %_r3069)
  ret i8* %_function3070
}
...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  %_gep3029 = getelementptr { i64, [0 x i8*] }, { i64, [0 x i8*] }* %_argv3028, i32 0, i32 1, i32 1
  %_load3030 = load i8*, i8** %_gep3029
  %_function3031 = call i8* @sub(i8* %_load3030, i64 3, i64 5)
  call void @print_string(i8* %_function3031)
  ret i64 0
}
