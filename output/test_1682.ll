...
_for_body195:
  ...
  %_elem_addr201 = getelementptr { i64, [0 x { i64, [0 x i64] }*] }, { i64, [0 x { i64, [0 x i64] }*] }* %_x199, i32 0, i32 1, i64 %_i200
  %_read_val202 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_elem_addr201
  %_elem_addr203 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_read_val202, i32 0, i32 1, i32 0
  %_read_val204 = load i64, i64* %_elem_addr203
  %_ans205 = load i64, i64* %_ans190
  %_bop206 = sub i64 %_read_val204, %_ans205
