...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  %_argv7283 = alloca { i64, [0 x i8*] }*
  %_x7286 = alloca { i64, [0 x i64] }*
  store i64 %argc, i64* %_argc7282
  store { i64, [0 x i8*] }* %argv, { i64, [0 x i8*] }** %_argv7283
  ...
  %_x7297 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_x7286
  %_gep7298 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_x7297, i32 0, i32 1, i32 2
