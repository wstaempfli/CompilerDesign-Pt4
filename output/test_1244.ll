...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %args) {
  ...
  %_args8000 = alloca { i64, [0 x i8*] }*
  store i64 %argc, i64* %_argc7998
  store { i64, [0 x i8*] }* %args, { i64, [0 x i8*] }** %_args8000
...
define i1 @function(i64 %x) {
  ...
  %_load7990 = load i64, i64* %_x7985
  %_bop7991 = icmp eq i64 %_load7990, 0
  br i1 %_bop7991, label %_then7987, label %_else7988
_then7987:
  ret i1 1
_else7988:
  %_load7995 = load i64, i64* %_x7985
  %_bop7996 = icmp eq i64 %_load7995, 1
