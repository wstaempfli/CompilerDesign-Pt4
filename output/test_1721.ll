...
define i64 @g({ i64, [0 x i64] }* %y) {
  ...
  %_elem_addr1106 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_y1105, i32 0, i32 1, i32 2
  %_read_val1107 = load i64, i64* %_elem_addr1106
  ret i64 %_read_val1107
}
...
_for_exit1074:
  ...
  %_funcall1084 = call i64 @g({ i64, [0 x i64] }* %_arr1083)
  %_i1085 = load i64, i64* @i
  %_funcall1086 = call i64 @f(i64 %_i1085)
  %_bop1087 = add i64 %_funcall1084, %_funcall1086
  %_arr1088 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_arr1066
  %_elem_addr1089 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_arr1088, i32 0, i32 1, i32 3
  %_read_val1090 = load i64, i64* %_elem_addr1089
  %_funcall1091 = call i64 @f(i64 %_read_val1090)
  %_bop1092 = add i64 %_bop1087, %_funcall1091
  %_garr1093 = load { i64, [0 x { i64, [0 x i64] }*] }*, { i64, [0 x { i64, [0 x i64] }*] }** %_garr1054
  %_elem_addr1094 = getelementptr { i64, [0 x { i64, [0 x i64] }*] }, { i64, [0 x { i64, [0 x i64] }*] }* %_garr1093, i32 0, i32 1, i32 1
  %_read_val1095 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_elem_addr1094
  %_elem_addr1096 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_read_val1095, i32 0, i32 1, i32 1
  %_read_val1097 = load i64, i64* %_elem_addr1096
  %_funcall1098 = call i64 @f(i64 %_read_val1097)
  %_bop1099 = add i64 %_bop1092, %_funcall1098
  %_p1100 = load i64, i64* %_p1068
  %_funcall1101 = call i64 @f(i64 %_p1100)
  %_bop1102 = add i64 %_bop1099, %_funcall1101
  ret i64 %_bop1102
}
