...
_for_exit5967:
  ...
  %_load5988 = load i64, i64* %_gep_ptr5987
  %_gep_ptr5987 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_partial5986, i32 0, i32 1, i32 0
...
_then6003:
  ...
  %_load6014 = load i64, i64* %_gep_ptr6013
  %_gep_ptr6013 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_partial6011, i32 0, i32 1, i64 %_i6012
...
_then6007:
  ...
  %_load6026 = load i64, i64* %_gep_ptr6025
  %_gep_ptr6025 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_partial6023, i32 0, i32 1, i64 %_i6024
...
_else6008:
  ...
  %_load6034 = load i64, i64* %_gep_ptr6033
  %_gep_ptr6033 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_partial6031, i32 0, i32 1, i64 %_i6032
...
_else6004:
  ...
  %_load6042 = load i64, i64* %_gep_ptr6041
  %_gep_ptr6041 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_partial6039, i32 0, i32 1, i64 %_i6040
...
define { i64, [0 x i64] }* @insort({ i64, [0 x i64] }* %unsorted, i64 %len) {
  ...
  store i64 0, i64* %_gep5921
  %_gep5921 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_array5920, i32 0, i32 1, i32 0
  store { i64, [0 x i64] }* %_array5920, { i64, [0 x i64] }** %_out5923
  %_unsorted5925 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_unsorted5915
  %_load5927 = load i64, i64* %_gep_ptr5926
  %_gep_ptr5926 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_unsorted5925, i32 0, i32 1, i32 0
...
_for_body5934:
  ...
  %_load5944 = load i64, i64* %_gep_ptr5943
  %_gep_ptr5943 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_unsorted5941, i32 0, i32 1, i64 %_i5942
...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  store i64 13, i64* %_gep5894
  %_gep5894 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_array5893, i32 0, i32 1, i32 0
  store i64 42, i64* %_gep5896
  %_gep5896 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_array5893, i32 0, i32 1, i32 1
  store i64 32, i64* %_gep5898
  %_gep5898 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_array5893, i32 0, i32 1, i32 2
  store i64 3, i64* %_gep5900
  %_gep5900 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_array5893, i32 0, i32 1, i32 3
  store i64 2, i64* %_gep5902
  %_gep5902 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_array5893, i32 0, i32 1, i32 4
  store i64 6, i64* %_gep5904
  %_gep5904 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_array5893, i32 0, i32 1, i32 5
  ...
  %_load5914 = load i64, i64* %_gep_ptr5913
  %_gep_ptr5913 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_result5912, i32 0, i32 1, i32 5
  ret i64 %_load5914
}
