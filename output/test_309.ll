...
@buf = global { i64, [0 x i64] }* bitcast ({ i64, [1 x i64] }* @_global_arr_data5887 to { i64, [0 x i64] }*)
@_global_arr_data5887 = global { i64, [1 x i64] } { i64 1, [1 x i64] [ i64 0 ] }
...
_join5798:
  ...
  %_call5807 = call { i64, [0 x i64] }* @array_of_string(i8* %_a5806)
  store { i64, [0 x i64] }* %_call5807, { i64, [0 x i64] }** %_a_chars5808
  %_b5810 = load i8*, i8** %_b5791
  %_call5811 = call { i64, [0 x i64] }* @array_of_string(i8* %_b5810)
  ...
  %_load5817 = load i64, i64* %_gep_ptr5816
  %_gep_ptr5816 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_a_chars5814, i32 0, i32 1, i64 %_i5815
  store i64 %_load5817, i64* %_last_char_a5818
  %_b_chars5820 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_b_chars5812
  %_j5821 = load i64, i64* %_j5789
  %_load5823 = load i64, i64* %_gep_ptr5822
  %_gep_ptr5822 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_b_chars5820, i32 0, i32 1, i64 %_j5821
...
_then5826:
  ...
  %_call5838 = call i8* @lcs(i64 %_bop5833, i64 %_bop5835, i8* %_a5836, i8* %_b5837)
  store i8* %_call5838, i8** %_prev_lcs5839
  %_a_chars5841 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_a_chars5808
  %_i5842 = load i64, i64* %_i5788
  %_load5844 = load i64, i64* %_gep_ptr5843
  %_gep_ptr5843 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_a_chars5841, i32 0, i32 1, i64 %_i5842
  ...
  %_call5849 = call i8* @string_of_array({ i64, [0 x i64] }* %_buf5848)
  store i8* %_call5849, i8** %_next_char5850
  %_next_char5853 = load i8*, i8** %_next_char5850
  %_prev_lcs5852 = load i8*, i8** %_prev_lcs5839
  %_call5854 = call i8* @string_cat(i8* %_prev_lcs5852, i8* %_next_char5853)
  ret i8* %_call5854
_else5827:
  br label %_join5828
_join5828:
  ...
  %_call5860 = call i8* @lcs(i64 %_i5855, i64 %_bop5857, i8* %_a5858, i8* %_b5859)
  ...
  %_call5868 = call i8* @lcs(i64 %_bop5864, i64 %_j5865, i8* %_a5866, i8* %_b5867)
  store i8* %_call5868, i8** %_right_lcs5869
  %_left_lcs5871 = load i8*, i8** %_left_lcs5861
  %_call5872 = call i64 @length_of_string(i8* %_left_lcs5871)
  store i64 %_call5872, i64* %_left_len5873
  %_right_lcs5875 = load i8*, i8** %_right_lcs5869
  %_call5876 = call i64 @length_of_string(i8* %_right_lcs5875)
...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  %_call5786 = call i8* @lcs(i64 5, i64 6, i8* %_tomato5784, i8* %_orating5785)
