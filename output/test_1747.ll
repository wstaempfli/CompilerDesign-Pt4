...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  %_elem_addr2732 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_b2731, i32 0, i32 1, i32 0
  %_read_val2733 = load i64, i64* %_elem_addr2732
  %_bop2734 = add i64 %_a2730, %_read_val2733
  %_b2735 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_b2720
  %_elem_addr2736 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_b2735, i32 0, i32 1, i32 1
  %_read_val2737 = load i64, i64* %_elem_addr2736
  %_bop2738 = add i64 %_bop2734, %_read_val2737
  ret i64 %_bop2738
}
