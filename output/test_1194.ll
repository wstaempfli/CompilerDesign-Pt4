...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %args) {
  ...
  %_args6550 = alloca { i64, [0 x i8*] }*
  store i64 %argc, i64* %_argc6548
  store { i64, [0 x i8*] }* %args, { i64, [0 x i8*] }** %_args6550
...
define i64 @function(i64 %x) {
  ...
  %_load6536 = load i64, i64* %_x6531
  %_bop6537 = icmp eq i64 %_load6536, 0
  br i1 %_bop6537, label %_then6533, label %_else6534
_then6533:
  br label %_join6535
_else6534:
  %_load6541 = load i64, i64* %_x6531
  %_bop6542 = icmp eq i64 %_load6541, 1
  br i1 %_bop6542, label %_then6538, label %_else6539
_then6538:
  br label %_join6540
_else6539:
  %_load6546 = load i64, i64* %_x6531
  %_bop6547 = icmp eq i64 %_load6546, 2
