...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  %_argv7433 = alloca { i64, [0 x i8*] }*
  %_x7436 = alloca i64
  store i64 %argc, i64* %_argc7432
  store { i64, [0 x i8*] }* %argv, { i64, [0 x i8*] }** %_argv7433
  store i64 0, i64* %_x7436
  br label %_while_cond7438
_while_cond7438:
  %_x7441 = load i64, i64* %_x7436
  %_bop7442 = icmp ne i64 %_x7441, 0
  br i1 %_bop7442, label %_while_body7439, label %_while_exit7440
_while_body7439:
  br label %_while_cond7438
_while_exit7440:
  %_x7443 = load i64, i64* %_x7436
  ret i64 %_x7443
}
