...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %args) {
  ...
  %_args6461 = alloca { i64, [0 x i8*] }*
  store i64 %argc, i64* %_argc6460
  store { i64, [0 x i8*] }* %args, { i64, [0 x i8*] }** %_args6461
...
define i64 @function(i64 %x) {
  ...
  %_x6453 = load i64, i64* %_x6448
  %_bop6454 = icmp eq i64 %_x6453, 0
  br i1 %_bop6454, label %_then6450, label %_else6451
_then6450:
  ret i64 10
_else6451:
  %_x6458 = load i64, i64* %_x6448
  %_bop6459 = icmp eq i64 %_x6458, 1
