...
_for_body139:
  ...
  %_elem_addr145 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_x143, i32 0, i32 1, i64 %_i144
  %_read_val146 = load i64, i64* %_elem_addr145
  %_x147 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_x132
  %_i148 = load i64, i64* %_i136
  %_elem_addr149 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_x147, i32 0, i32 1, i64 %_i148
  %_read_val150 = load i64, i64* %_elem_addr149
  %_uop151 = xor i64 %_read_val150, -1
  %_bop152 = mul i64 %_read_val146, %_uop151
