...
define i64 @maxsum({ i64, [0 x i64] }* %arr, i64 %size) {
  ...
  %_load6092 = load i64, i64* %_gep_ptr6091
  %_gep_ptr6091 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_arr6090, i32 0, i32 1, i32 0
...
_for_body6107:
  ...
  %_load6118 = load i64, i64* %_gep_ptr6117
  %_gep_ptr6117 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_arr6115, i32 0, i32 1, i64 %_i6116
  %_arr6119 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_arr6079
  %_j6120 = load i64, i64* %_j6104
  %_load6122 = load i64, i64* %_gep_ptr6121
  %_gep_ptr6121 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_arr6119, i32 0, i32 1, i64 %_j6120
  %_bop6123 = icmp sgt i64 %_load6118, %_load6122
  %_maxarr6124 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_maxarr6086
  %_i6125 = load i64, i64* %_i6096
  %_load6127 = load i64, i64* %_gep_ptr6126
  %_gep_ptr6126 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_maxarr6124, i32 0, i32 1, i64 %_i6125
  %_maxarr6128 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_maxarr6086
  %_j6129 = load i64, i64* %_j6104
  %_load6131 = load i64, i64* %_gep_ptr6130
  %_gep_ptr6130 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_maxarr6128, i32 0, i32 1, i64 %_j6129
  %_arr6132 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_arr6079
  %_i6133 = load i64, i64* %_i6096
  %_load6135 = load i64, i64* %_gep_ptr6134
  %_gep_ptr6134 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_arr6132, i32 0, i32 1, i64 %_i6133
...
_then6112:
  ...
  %_load6142 = load i64, i64* %_gep_ptr6141
  %_gep_ptr6141 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_maxarr6139, i32 0, i32 1, i64 %_j6140
  %_arr6143 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_arr6079
  %_i6144 = load i64, i64* %_i6096
  %_load6146 = load i64, i64* %_gep_ptr6145
  %_gep_ptr6145 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_arr6143, i32 0, i32 1, i64 %_i6144
...
_for_exit6108:
  ...
  %_load6162 = load i64, i64* %_gep_ptr6161
  %_gep_ptr6161 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_maxarr6159, i32 0, i32 1, i64 %_i6160
  %_bop6163 = icmp slt i64 %_maxs6158, %_load6162
...
_then6155:
  ...
  %_load6167 = load i64, i64* %_gep_ptr6166
  %_gep_ptr6166 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_maxarr6164, i32 0, i32 1, i64 %_i6165
...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  %_gep6058 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_array6057, i32 0, i32 1, i32 0
  store i64 101, i64* %_gep6060
  %_gep6060 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_array6057, i32 0, i32 1, i32 1
  store i64 2, i64* %_gep6062
  %_gep6062 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_array6057, i32 0, i32 1, i32 2
  store i64 3, i64* %_gep6064
  %_gep6064 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_array6057, i32 0, i32 1, i32 3
  store i64 101, i64* %_gep6066
  %_gep6066 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_array6057, i32 0, i32 1, i32 4
  store i64 4, i64* %_gep6068
  %_gep6068 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_array6057, i32 0, i32 1, i32 5
  store i64 5, i64* %_gep6070
  %_gep6070 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_array6057, i32 0, i32 1, i32 6
  store { i64, [0 x i64] }* %_array6057, { i64, [0 x i64] }** %_array6072
  %_array6074 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_array6072
  %_call6075 = call i64 @maxsum({ i64, [0 x i64] }* %_array6074, i64 7)
