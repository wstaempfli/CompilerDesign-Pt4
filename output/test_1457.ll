...
_for_body5934:
  ...
  %_function5945 = call { i64, [0 x i64] }* @insert({ i64, [0 x i64] }* %_out5939, i64 %_i5940, i64 %_load5944)
  store { i64, [0 x i64] }* %_function5945, { i64, [0 x i64] }** %_out5923
...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  %_function5909 = call { i64, [0 x i64] }* @insort({ i64, [0 x i64] }* %_array5908, i64 6)
  store { i64, [0 x i64] }* %_function5909, { i64, [0 x i64] }** %_result5910
