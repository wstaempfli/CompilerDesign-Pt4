...
define i64 @f(i64 %x1, i64 %x2, i64 %x3, i64 %x4, i64 %x5, i64 %x6, i64 %x7, i64 %x8) {
  ...
  %_x7269 = alloca i64
  %_x8270 = alloca i64
  store i64 %x1, i64* %_x1263
  store i64 %x2, i64* %_x2264
  store i64 %x3, i64* %_x3265
  store i64 %x4, i64* %_x4266
  store i64 %x5, i64* %_x5267
  store i64 %x6, i64* %_x6268
  store i64 %x7, i64* %_x7269
  store i64 %x8, i64* %_x8270
...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  store { i64, [0 x i8*] }* %argv, { i64, [0 x i8*] }** %_argv256
  %_uop261 = sub i64 0, 3
  %_uop260 = sub i64 0, 4
  %_uop259 = sub i64 0, 5
