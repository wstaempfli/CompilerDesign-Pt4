...
_while_body5307:
  ...
  %_5318 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_a5315, i32 0, i32 1, i64 %_bop5317
  %_5319 = load i64, i64* %_5318
  %_a5320 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_a5298
  %_i5321 = load i64, i64* %_i5302
  %_5322 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_a5320, i32 0, i32 1, i64 %_i5321
  %_5323 = load i64, i64* %_5322
  %_bop5324 = icmp sle i64 %_5319, %_5323
...
_else5313:
  ...
  %_5333 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_a5330, i32 0, i32 1, i64 %_bop5332
  %_5334 = load i64, i64* %_5333
  store i64 %_5334, i64* %_tmp5335
  %_a5337 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_a5298
  %_i5338 = load i64, i64* %_i5302
  %_5339 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_a5337, i32 0, i32 1, i64 %_i5338
  %_5340 = load i64, i64* %_5339
...
_for_body5286:
  ...
  %_5292 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_arr5290, i32 0, i32 1, i64 %_i5291
  %_5293 = load i64, i64* %_5292
  call void @print_int(i64 %_5293)
