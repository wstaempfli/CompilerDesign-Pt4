...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  %_argv1233 = alloca { i64, [0 x i8*] }*
  store i64 %argc, i64* %_argc1231
  store { i64, [0 x i8*] }* %argv, { i64, [0 x i8*] }** %_argv1233
  ...
  %_load1288 = load { i64, [0 x { i64, [0 x { i64, [0 x i64] }*] }*] }*, { i64, [0 x { i64, [0 x { i64, [0 x i64] }*] }*] }** @arr
  %_gep1289 = getelementptr { i64, [0 x { i64, [0 x { i64, [0 x i64] }*] }*] }, { i64, [0 x { i64, [0 x { i64, [0 x i64] }*] }*] }* %_load1288, i32 0, i32 1, i32 2
  %_load1290 = load { i64, [0 x { i64, [0 x i64] }*] }*, { i64, [0 x { i64, [0 x i64] }*] }** %_gep1289
  %_gep1291 = getelementptr { i64, [0 x { i64, [0 x i64] }*] }, { i64, [0 x { i64, [0 x i64] }*] }* %_load1290, i32 0, i32 1, i32 0
  %_load1292 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_gep1291
  %_gep1293 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_load1292, i32 0, i32 1, i32 1
  %_load1294 = load i64, i64* %_gep1293
  ret i64 %_load1294
}
