...
_for_exit1550:
  ...
  %_function1570 = call i64 @f({ i64, [0 x i64] }* %_arr01569)
  %_bop1571 = add i64 %_bop1568, %_function1570
  %_function1572 = call i64 @g(i64 4)
  %_bop1573 = add i64 %_bop1571, %_function1572
  ret i64 %_bop1573
}
