...
@lfsr_init_values = global { i64, [0 x i1] }* bitcast ({ i64, [4 x i1] }* @_global_arr_data5253 to { i64, [0 x i1] }*)
@_global_arr_data5253 = global { i64, [4 x i1] } { i64 4, [4 x i1] [ i1 1, i1 0, i1 1, i1 0 ] }
...
_for_body5216:
  ...
  %_load5224 = load i1, i1* %_gep_ptr5223
  %_gep_ptr5223 = getelementptr { i64, [0 x i1] }, { i64, [0 x i1] }* %_lfsr_register5221, i32 0, i32 1, i64 %_i5222
...
_for_body5135:
  ...
  %_load5143 = load i1, i1* %_gep_ptr5142
  %_gep_ptr5142 = getelementptr { i64, [0 x i1] }, { i64, [0 x i1] }* %_lfsr_init_values5140, i32 0, i32 1, i64 %_i5141
...
_for_body5154:
  ...
  %_load5168 = load i1, i1* %_gep_ptr5167
  %_gep_ptr5167 = getelementptr { i64, [0 x i1] }, { i64, [0 x i1] }* %_lfsr_register5164, i32 0, i32 1, i64 %_bop5166
  ...
  %_load5163 = load i1, i1* %_gep_ptr5162
  %_gep_ptr5162 = getelementptr { i64, [0 x i1] }, { i64, [0 x i1] }* %_lfsr_register5159, i32 0, i32 1, i64 %_bop5161
...
_for_body5177:
  ...
  %_load5185 = load i1, i1* %_gep_ptr5184
  %_gep_ptr5184 = getelementptr { i64, [0 x i1] }, { i64, [0 x i1] }* %_lfsr_register5181, i32 0, i32 1, i64 %_bop5183
