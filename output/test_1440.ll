...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  %_function3571 = call i8* @string_of_array({ i64, [0 x i64] }* %_a3570)
  call void @print_string(i8* %_function3571)
  ...
  %_function3579 = call i8* @string_of_array({ i64, [0 x i64] }* %_a3578)
  call void @print_string(i8* %_function3579)
