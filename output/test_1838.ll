...
define i64 @f({ i64, [0 x i64] }* %arr) {
  ...
  %_1496 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_arr1495, i32 0, i32 1, i32 3
  %_1497 = load i64, i64* %_1496
  ret i64 %_1497
}
...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  %_1450 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_arr11449, i32 0, i32 1, i32 1
  %_1451 = load i64, i64* %_1450
  %_bop1452 = add i64 %_c1448, %_1451
  store i64 %_bop1452, i64* %_c1427
  %_c1454 = load i64, i64* %_c1427
  %_arr21455 = load { i64, [0 x { i64, [0 x i64] }*] }*, { i64, [0 x { i64, [0 x i64] }*] }** %_arr21425
  %_1456 = getelementptr { i64, [0 x { i64, [0 x i64] }*] }, { i64, [0 x { i64, [0 x i64] }*] }* %_arr21455, i32 0, i32 1, i32 1
  %_1457 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_1456
  %_1458 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_1457, i32 0, i32 1, i32 1
  %_1459 = load i64, i64* %_1458
  %_bop1460 = add i64 %_c1454, %_1459
  store i64 %_bop1460, i64* %_c1427
  %_c1462 = load i64, i64* %_c1427
  %_arr31463 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_arr31442
  %_1464 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_arr31463, i32 0, i32 1, i32 3
  %_1465 = load i64, i64* %_1464
  %_bop1466 = add i64 %_c1462, %_1465
  ...
  %_1475 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_arr41474, i32 0, i32 1, i32 1
  %_1476 = load i64, i64* %_1475
  %_bop1477 = add i64 %_c1473, %_1476
