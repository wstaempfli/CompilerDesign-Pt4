...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  %_funcall3571 = call i8* @string_of_array({ i64, [0 x i64] }* %_a3570)
  call void @print_string(i8* %_funcall3571)
  %_a3573 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_a3568
  call void @oat_mergesort({ i64, [0 x i64] }* %_a3573, i64 0, i64 9)
  %_str3576 = bitcast [2 x i8]* @_str3575 to i8*
  call void @print_string(i8* %_str3576)
  %_a3578 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_a3568
  %_funcall3579 = call i8* @string_of_array({ i64, [0 x i64] }* %_a3578)
  call void @print_string(i8* %_funcall3579)
  %_str3582 = bitcast [2 x i8]* @_str3581 to i8*
  call void @print_string(i8* %_str3582)
...
_while_body3399:
  ...
  %_elem_addr3413 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_a3411, i32 0, i32 1, i64 %_i3412
  %_read_val3414 = load i64, i64* %_elem_addr3413
  %_a3415 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_a3373
  %_j3416 = load i64, i64* %_j3383
  %_elem_addr3417 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_a3415, i32 0, i32 1, i64 %_j3416
  %_read_val3418 = load i64, i64* %_elem_addr3417
  %_bop3419 = icmp slt i64 %_read_val3414, %_read_val3418
  br i1 %_bop3419, label %_then3408, label %_else3409
_then3408:
  %_a3420 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_a3373
  %_i3421 = load i64, i64* %_i3381
  %_elem_addr3422 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_a3420, i32 0, i32 1, i64 %_i3421
  %_read_val3423 = load i64, i64* %_elem_addr3422
  ...
  store i64 %_read_val3423, i64* %_gep3426
...
_else3409:
  ...
  %_elem_addr3436 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_a3434, i32 0, i32 1, i64 %_j3435
  %_read_val3437 = load i64, i64* %_elem_addr3436
  ...
  store i64 %_read_val3437, i64* %_gep3440
...
_while_body3449:
  ...
  %_elem_addr3456 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_a3454, i32 0, i32 1, i64 %_i3455
  %_read_val3457 = load i64, i64* %_elem_addr3456
  ...
  store i64 %_read_val3457, i64* %_gep3460
...
_while_body3469:
  ...
  %_elem_addr3476 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_a3474, i32 0, i32 1, i64 %_j3475
  %_read_val3477 = load i64, i64* %_elem_addr3476
  ...
  store i64 %_read_val3477, i64* %_gep3480
...
_for_body3491:
  ...
  %_elem_addr3498 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_c3496, i32 0, i32 1, i64 %_i3497
  %_read_val3499 = load i64, i64* %_elem_addr3498
  ...
  store i64 %_read_val3499, i64* %_gep3502
