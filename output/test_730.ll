...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  br label %_while_cond699
_while_cond699:
  %_i702 = load i64, i64* %_i697
  %_bop703 = icmp slt i64 %_i702, 3
  br i1 %_bop703, label %_while_body700, label %_while_end701
_while_body700:
  store i64 0, i64* %_j704
  br label %_while_cond706
_while_cond706:
  %_j709 = load i64, i64* %_j704
  %_bop710 = icmp slt i64 %_j709, 4
  br i1 %_bop710, label %_while_body707, label %_while_end708
_while_body707:
