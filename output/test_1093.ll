...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  %_argc466 = alloca i64
  %_argv468 = alloca { i64, [0 x i8*] }*
  %_i476 = alloca { i64, [0 x i64] }*
  store i64 %argc, i64* %_argc466
  store { i64, [0 x i8*] }* %argv, { i64, [0 x i8*] }** %_argv468
  ...
  %_load478 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_i476
  %_gep479 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_load478, i32 0, i32 1, i32 0
  %_load480 = load i64, i64* %_gep479
  ret i64 %_load480
}
