...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  %_gep1368 = getelementptr { i64, [0 x { i64, [0 x i64] }*] }, { i64, [0 x { i64, [0 x i64] }*] }* %_garr1367, i32 0, i32 1, i32 1
  %_load1369 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_gep1368
  %_function1370 = call { i64, [0 x i64] }* @f({ i64, [0 x i64] }* %_load1369)
  store { i64, [0 x i64] }* %_function1370, { i64, [0 x i64] }** %_arr1371
  %_arr1373 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_arr1371
  %_gep1374 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_arr1373, i32 0, i32 1, i32 1
