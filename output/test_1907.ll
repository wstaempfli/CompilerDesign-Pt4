...
_for_exit335:
  ...
  %_funcall349 = call { i64, [0 x i64] }* @f({ i64, [0 x i64] }* %_x347, { i64, [0 x i64] }* %_y348, i1 1)
  %_gep350 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_funcall349, i32 0, i32 1, i32 0
  store i64 17, i64* %_gep350
  %_x352 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_x310
  %_elem_addr353 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_x352, i32 0, i32 1, i32 0
  %_read_val354 = load i64, i64* %_elem_addr353
  ret i64 %_read_val354
}
