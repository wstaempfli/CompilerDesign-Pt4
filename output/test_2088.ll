...
_for_body4500:
  ...
  %_elem_addr4510 = getelementptr { i64, [0 x i1] }, { i64, [0 x i1] }* %_arr4508, i32 0, i32 1, i64 %_i4509
  %_read_val4511 = load i1, i1* %_elem_addr4510
  br i1 %_read_val4511, label %_then4505, label %_else4506
_then4505:
...
_for_body4538:
  ...
  %_elem_addr4548 = getelementptr { i64, [0 x i1] }, { i64, [0 x i1] }* %_arr4546, i32 0, i32 1, i64 %_i4547
  %_read_val4549 = load i1, i1* %_elem_addr4548
  br i1 %_read_val4549, label %_then4543, label %_else4544
_then4543:
...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  %_funcall4468 = call i64 @sieve(i64 %_n4467)
  ret i64 %_funcall4468
}
