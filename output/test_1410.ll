...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  %_function1429 = call { i64, [0 x i64] }* @g()
  store { i64, [0 x i64] }* %_function1429, { i64, [0 x i64] }** %_arr41430
  ...
  %_function1470 = call i64 @f({ i64, [0 x i64] }* %_arr31469)
  %_bop1471 = add i64 %_c1468, %_function1470
