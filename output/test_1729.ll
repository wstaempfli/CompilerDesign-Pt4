...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  %_elem_addr1335 = getelementptr { i64, [0 x { i64, [0 x i64] }*] }, { i64, [0 x { i64, [0 x i64] }*] }* %_arr1334, i32 0, i32 1, i32 1
  %_read_val1336 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_elem_addr1335
  %_elem_addr1337 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_read_val1336, i32 0, i32 1, i32 1
  %_read_val1338 = load i64, i64* %_elem_addr1337
  ret i64 %_read_val1338
}
