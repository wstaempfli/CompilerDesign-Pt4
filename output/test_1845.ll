...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  %_str1972 = bitcast [4 x i8]* @_str1971 to i8*
  %_gep_lit1973 = getelementptr { i64, [0 x i8*] }, { i64, [0 x i8*] }* %_array1970, i32 0, i32 1, i32 0
  store i8* %_str1972, i8** %_gep_lit1973
  %_str1976 = bitcast [4 x i8]* @_str1975 to i8*
  %_gep_lit1977 = getelementptr { i64, [0 x i8*] }, { i64, [0 x i8*] }* %_array1970, i32 0, i32 1, i32 1
  store i8* %_str1976, i8** %_gep_lit1977
  store { i64, [0 x i8*] }* %_array1970, { i64, [0 x i8*] }** %_strs1979
  %_strs1981 = load { i64, [0 x i8*] }*, { i64, [0 x i8*] }** %_strs1979
  %_1982 = getelementptr { i64, [0 x i8*] }, { i64, [0 x i8*] }* %_strs1981, i32 0, i32 1, i32 0
  %_1983 = load i8*, i8** %_1982
  call void @print_string(i8* %_1983)
  ret i64 0
}
