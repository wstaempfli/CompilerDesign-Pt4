...
define { i64, [0 x i64] }* @get() {
  %_mat_16585 = load { i64, [0 x { i64, [0 x i64] }*] }*, { i64, [0 x { i64, [0 x i64] }*] }** @mat_1
  %_gep6586 = getelementptr { i64, [0 x { i64, [0 x i64] }*] }, { i64, [0 x { i64, [0 x i64] }*] }* %_mat_16585, i32 0, i32 1, i32 0
...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %args) {
  ...
  %_args6564 = alloca { i64, [0 x i8*] }*
  %_x6582 = alloca i64
  store i64 %argc, i64* %_argc6563
  store { i64, [0 x i8*] }* %args, { i64, [0 x i8*] }** %_args6564
  %_mat_16567 = load { i64, [0 x { i64, [0 x i64] }*] }*, { i64, [0 x { i64, [0 x i64] }*] }** @mat_1
  %_gep6568 = getelementptr { i64, [0 x { i64, [0 x i64] }*] }, { i64, [0 x { i64, [0 x i64] }*] }* %_mat_16567, i32 0, i32 1, i32 1
  ...
  %_mat_16572 = load { i64, [0 x { i64, [0 x i64] }*] }*, { i64, [0 x { i64, [0 x i64] }*] }** @mat_1
  %_gep6573 = getelementptr { i64, [0 x { i64, [0 x i64] }*] }, { i64, [0 x { i64, [0 x i64] }*] }* %_mat_16572, i32 0, i32 1, i32 2
