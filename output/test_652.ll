...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  store { i64, [0 x i8*] }* %argv, { i64, [0 x i8*] }** %_argv7302
  ...
  %_x7314 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** @x
  %_gep7315 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_x7314, i32 0, i32 1, i32 2
