...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %args) {
  ...
  %_args6487 = alloca { i64, [0 x i8*] }*
  store i64 %argc, i64* %_argc6486
  store { i64, [0 x i8*] }* %args, { i64, [0 x i8*] }** %_args6487
...
define i64 @function(i64 %x) {
  ...
  %_x6474 = load i64, i64* %_x6469
  %_bop6475 = icmp eq i64 %_x6474, 0
  br i1 %_bop6475, label %_then6471, label %_else6472
_then6471:
  ret i64 10
_else6472:
  %_x6479 = load i64, i64* %_x6469
  %_bop6480 = icmp eq i64 %_x6479, 1
  br i1 %_bop6480, label %_then6476, label %_else6477
_then6476:
  ret i64 0
_else6477:
  %_x6484 = load i64, i64* %_x6469
  %_bop6485 = icmp eq i64 %_x6484, 2
