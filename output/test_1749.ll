...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  %_funcall2766 = call { i64, [0 x i64] }* @array_of_string(i8* %_str2765)
  store { i64, [0 x i64] }* %_funcall2766, { i64, [0 x i64] }** %_arr2767
...
_for_body2774:
  ...
  %_elem_addr2781 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_arr2779, i32 0, i32 1, i64 %_i2780
  %_read_val2782 = load i64, i64* %_elem_addr2781
  %_bop2783 = add i64 %_s2778, %_read_val2782
