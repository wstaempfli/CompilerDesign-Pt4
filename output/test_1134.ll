...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  %_argv1987 = alloca { i64, [0 x i8*] }*
  %_strs2015 = alloca { i64, [0 x { i64, [0 x i8*] }*] }*
  store i64 %argc, i64* %_argc1985
  store { i64, [0 x i8*] }* %argv, { i64, [0 x i8*] }** %_argv1987
  ...
  %_load2017 = load { i64, [0 x { i64, [0 x i8*] }*] }*, { i64, [0 x { i64, [0 x i8*] }*] }** %_strs2015
  %_gep2018 = getelementptr { i64, [0 x { i64, [0 x i8*] }*] }, { i64, [0 x { i64, [0 x i8*] }*] }* %_load2017, i32 0, i32 1, i32 1
