...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  store i64 3, i64* %_elem_ptr271
  %_elem_ptr271 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_x270, i32 0, i32 1, i32 2
  %_x270 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_x266
  %_arr273 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** @arr
  %_gep274 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_arr273, i32 0, i32 1, i32 2
