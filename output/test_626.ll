...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %args) {
  ...
  %_args6191 = alloca { i64, [0 x i8*] }*
  %_x6194 = alloca i64
  store i64 %argc, i64* %_argc6190
  store { i64, [0 x i8*] }* %args, { i64, [0 x i8*] }** %_args6191
...
_while_body6197:
  %_x6200 = load i64, i64* %_x6194
  %_bop6201 = add i64 %_x6200, 1
  store i64 %_bop6201, i64* %_x6194
  %_counter6203 = load i64, i64* @counter
  %_bop6204 = sub i64 %_counter6203, 1
  store i64 %_bop6204, i64* @counter
  br label %_while_cond6196
_while_exit6198:
  %_x6206 = load i64, i64* %_x6194
  ret i64 %_x6206
}

define i1 @condition() {
  %_counter6188 = load i64, i64* @counter
  %_bop6189 = icmp sgt i64 %_counter6188, 50
  ret i1 %_bop6189
}
