...
_then5745:
  ...
  %_elem_addr5764 = getelementptr { i64, [0 x { i64, [0 x i64] }*] }, { i64, [0 x { i64, [0 x i64] }*] }* %_board5762, i32 0, i32 1, i64 %_i5763
  %_read_val5765 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_elem_addr5764
  %_j5766 = load i64, i64* %_j5739
  %_elem_addr5767 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_read_val5765, i32 0, i32 1, i64 %_j5766
  %_read_val5768 = load i64, i64* %_elem_addr5767
  %_bop5769 = add i64 %_count5761, %_read_val5768
  ret i64 %_bop5769
_else5746:
...
define i64 @val_at({ i64, [0 x { i64, [0 x i64] }*] }* %board, i64 %i, i64 %j) {
  ...
  %_elem_addr5648 = getelementptr { i64, [0 x { i64, [0 x i64] }*] }, { i64, [0 x { i64, [0 x i64] }*] }* %_board5646, i32 0, i32 1, i64 %_i5647
  %_read_val5649 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_elem_addr5648
  %_j5650 = load i64, i64* %_j5642
  %_elem_addr5651 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_read_val5649, i32 0, i32 1, i64 %_j5650
  %_read_val5652 = load i64, i64* %_elem_addr5651
  store i64 %_read_val5652, i64* %_alive5653
  ...
  %_funcall5663 = call i64 @check({ i64, [0 x { i64, [0 x i64] }*] }* %_board5657, i64 %_bop5659, i64 %_bop5661, i64 %_count5662)
  store i64 %_funcall5663, i64* %_count5655
  ...
  %_funcall5670 = call i64 @check({ i64, [0 x { i64, [0 x i64] }*] }* %_board5665, i64 %_bop5667, i64 %_j5668, i64 %_count5669)
  store i64 %_funcall5670, i64* %_count5655
  ...
  %_funcall5678 = call i64 @check({ i64, [0 x { i64, [0 x i64] }*] }* %_board5672, i64 %_bop5674, i64 %_bop5676, i64 %_count5677)
  store i64 %_funcall5678, i64* %_count5655
  ...
  %_funcall5685 = call i64 @check({ i64, [0 x { i64, [0 x i64] }*] }* %_board5680, i64 %_i5681, i64 %_bop5683, i64 %_count5684)
  store i64 %_funcall5685, i64* %_count5655
  ...
  %_funcall5692 = call i64 @check({ i64, [0 x { i64, [0 x i64] }*] }* %_board5687, i64 %_i5688, i64 %_bop5690, i64 %_count5691)
  store i64 %_funcall5692, i64* %_count5655
  ...
  %_funcall5700 = call i64 @check({ i64, [0 x { i64, [0 x i64] }*] }* %_board5694, i64 %_bop5696, i64 %_bop5698, i64 %_count5699)
  store i64 %_funcall5700, i64* %_count5655
  ...
  %_funcall5707 = call i64 @check({ i64, [0 x { i64, [0 x i64] }*] }* %_board5702, i64 %_bop5704, i64 %_j5705, i64 %_count5706)
  store i64 %_funcall5707, i64* %_count5655
  ...
  %_funcall5715 = call i64 @check({ i64, [0 x { i64, [0 x i64] }*] }* %_board5709, i64 %_bop5711, i64 %_bop5713, i64 %_count5714)
  store i64 %_funcall5715, i64* %_count5655
...
_for_body5589:
  ...
  %_funcall5596 = call i64 @val_at({ i64, [0 x { i64, [0 x i64] }*] }* %_board5593, i64 %_i5594, i64 %_j5595)
  %_new_board5597 = load { i64, [0 x { i64, [0 x i64] }*] }*, { i64, [0 x { i64, [0 x i64] }*] }** %_new_board5571
  %_i5598 = load i64, i64* %_i5573
  %_elem_addr5599 = getelementptr { i64, [0 x { i64, [0 x i64] }*] }, { i64, [0 x { i64, [0 x i64] }*] }* %_new_board5597, i32 0, i32 1, i64 %_i5598
  %_read_val5600 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_elem_addr5599
  %_j5601 = load i64, i64* %_j5586
  %_gep5602 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_read_val5600, i32 0, i32 1, i64 %_j5601
  store i64 %_funcall5596, i64* %_gep5602
...
_for_body5621:
  ...
  %_elem_addr5628 = getelementptr { i64, [0 x { i64, [0 x i64] }*] }, { i64, [0 x { i64, [0 x i64] }*] }* %_new_board5626, i32 0, i32 1, i64 %_i5627
  %_read_val5629 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_elem_addr5628
  %_j5630 = load i64, i64* %_j5618
  %_elem_addr5631 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_read_val5629, i32 0, i32 1, i64 %_j5630
  %_read_val5632 = load i64, i64* %_elem_addr5631
  call void @print_int(i64 %_read_val5632)
