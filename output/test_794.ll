...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  br label %_while_cond5134
_while_cond5134:
  %_i5137 = load i64, i64* %_i5132
  %_lfsr_length5138 = load i64, i64* @lfsr_length
  %_bop5139 = icmp slt i64 %_i5137, %_lfsr_length5138
  br i1 %_bop5139, label %_while_body5135, label %_while_end5136
_while_body5135:
  store i1 %_load5143, i1* %_elem_ptr5146
  %_elem_ptr5146 = getelementptr { i64, [0 x i1] }, { i64, [0 x i1] }* %_lfsr_register5144, i32 0, i32 1, i64 %_i5145
  %_lfsr_init_values5140 = load { i64, [0 x i1] }*, { i64, [0 x i1] }** @lfsr_init_values
  %_i5141 = load i64, i64* %_i5132
  %_gep5142 = getelementptr { i64, [0 x i1] }, { i64, [0 x i1] }* %_lfsr_init_values5140, i32 0, i32 1, i64 %_i5141
  ...
  br label %_while_end5136
_while_end5136:
  store i64 0, i64* %_i5151
  br label %_while_cond5153
_while_cond5153:
  ...
  br i1 %_bop5158, label %_while_body5154, label %_while_end5155
_while_body5154:
  ...
  %_gep5167 = getelementptr { i64, [0 x i1] }, { i64, [0 x i1] }* %_lfsr_register5164, i32 0, i32 1, i64 %_bop5166
  ...
  %_gep5162 = getelementptr { i64, [0 x i1] }, { i64, [0 x i1] }* %_lfsr_register5159, i32 0, i32 1, i64 %_bop5161
  ...
  br label %_while_cond5176
_while_cond5176:
  %_j5179 = load i64, i64* %_j5174
  %_bop5180 = icmp sgt i64 %_j5179, 0
  br i1 %_bop5180, label %_while_body5177, label %_while_end5178
_while_body5177:
  store i1 %_load5185, i1* %_elem_ptr5188
  %_elem_ptr5188 = getelementptr { i64, [0 x i1] }, { i64, [0 x i1] }* %_lfsr_register5186, i32 0, i32 1, i64 %_j5187
  %_lfsr_register5181 = load { i64, [0 x i1] }*, { i64, [0 x i1] }** %_lfsr_register5130
  %_j5182 = load i64, i64* %_j5174
  %_bop5183 = sub i64 %_j5182, 1
  %_gep5184 = getelementptr { i64, [0 x i1] }, { i64, [0 x i1] }* %_lfsr_register5181, i32 0, i32 1, i64 %_bop5183
  ...
  br label %_while_end5178
_while_end5178:
  store i1 %_new_first5193, i1* %_elem_ptr5195
  %_elem_ptr5195 = getelementptr { i64, [0 x i1] }, { i64, [0 x i1] }* %_lfsr_register5194, i32 0, i32 1, i32 0
