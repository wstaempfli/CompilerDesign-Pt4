...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  %_argv1312 = alloca { i64, [0 x i8*] }*
  %_arr1332 = alloca { i64, [0 x { i64, [0 x i64] }*] }*
  store i64 %argc, i64* %_argc1310
  store { i64, [0 x i8*] }* %argv, { i64, [0 x i8*] }** %_argv1312
  ...
  %_load1334 = load { i64, [0 x { i64, [0 x i64] }*] }*, { i64, [0 x { i64, [0 x i64] }*] }** %_arr1332
  %_gep1335 = getelementptr { i64, [0 x { i64, [0 x i64] }*] }, { i64, [0 x { i64, [0 x i64] }*] }* %_load1334, i32 0, i32 1, i32 1
