...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  store i1 1, i1* %_gep559
  %_gep559 = getelementptr { i64, [0 x i1] }, { i64, [0 x i1] }* %_array558, i32 0, i32 1, i32 0
  store i1 0, i1* %_gep561
  %_gep561 = getelementptr { i64, [0 x i1] }, { i64, [0 x i1] }* %_array558, i32 0, i32 1, i32 1
  store { i64, [0 x i1] }* %_array558, { i64, [0 x i1] }** %_b563
  store i64 0, i64* %_i565
  %_b570 = load { i64, [0 x i1] }*, { i64, [0 x i1] }** %_b563
  %_load572 = load i1, i1* %_gep_ptr571
  %_gep_ptr571 = getelementptr { i64, [0 x i1] }, { i64, [0 x i1] }* %_b570, i32 0, i32 1, i32 0
  br i1 %_load572, label %_then567, label %_else568
_then567:
