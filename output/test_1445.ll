...
define i64 @xor_shift_plus({ i64, [0 x i64] }* %s) {
  ...
  %_function4428 = call i64 @xor(i64 %_x4425, i64 %_bop4427)
  store i64 %_function4428, i64* %_x4414
  %_x4431 = load i64, i64* %_x4414
  %_bop4432 = lshr i64 %_x4431, 17
  %_x4430 = load i64, i64* %_x4414
  %_function4433 = call i64 @xor(i64 %_x4430, i64 %_bop4432)
  store i64 %_function4433, i64* %_x4414
  %_y4437 = load i64, i64* %_y4419
  %_bop4438 = lshr i64 %_y4437, 26
  %_y4436 = load i64, i64* %_y4419
  %_function4439 = call i64 @xor(i64 %_y4436, i64 %_bop4438)
  %_x4435 = load i64, i64* %_x4414
  %_function4440 = call i64 @xor(i64 %_x4435, i64 %_function4439)
  store i64 %_function4440, i64* %_x4414
...
_for_exit4387:
  ...
  %_function4401 = call i64 @xor_shift_plus({ i64, [0 x i64] }* %_seed4400)
  call void @print_int(i64 %_function4401)
  ...
  %_function4407 = call i64 @xor_shift_plus({ i64, [0 x i64] }* %_seed4406)
  call void @print_int(i64 %_function4407)
  ret i64 0
}
