...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  store i64 110, i64* %_gep2037
  %_gep2037 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_array2036, i32 0, i32 1, i32 0
  store i64 110, i64* %_gep2039
  %_gep2039 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_array2036, i32 0, i32 1, i32 1
  store i64 110, i64* %_gep2041
  %_gep2041 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_array2036, i32 0, i32 1, i32 2
  store { i64, [0 x i64] }* %_array2036, { i64, [0 x i64] }** %_a2043
  %_a2045 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_a2043
  %_call2046 = call i8* @string_of_array({ i64, [0 x i64] }* %_a2045)
  store i8* %_call2046, i8** %_str2047
