...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  store { i64, [0 x i8*] }* %argv, { i64, [0 x i8*] }** %_argv2874
  ...
  %_load2890 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_arr12888
  %_call2891 = call i8* @string_of_array({ i64, [0 x i64] }* %_load2890)
  store i8* %_call2891, i8** %_str2892
  %_load2894 = load i8*, i8** %_str2892
  %_call2895 = call { i64, [0 x i64] }* @array_of_string(i8* %_load2894)
  store { i64, [0 x i64] }* %_call2895, { i64, [0 x i64] }** %_arr22896
  store i64 0, i64* %_s2898
  store i64 0, i64* %_i2900
  br label %_for_cond2902
_for_cond2902:
  %_load2905 = load i64, i64* %_i2900
  %_bop2906 = icmp slt i64 %_load2905, 5
  br i1 %_bop2906, label %_for_body2903, label %_for_exit2904
_for_body2903:
  %_load2907 = load i64, i64* %_s2898
  %_load2908 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_arr22896
  %_load2909 = load i64, i64* %_i2900
  %_gep2910 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_load2908, i32 0, i32 1, i64 %_load2909
  %_load2911 = load i64, i64* %_gep2910
  %_bop2912 = add i64 %_load2907, %_load2911
  store i64 %_bop2912, i64* %_s2898
  %_load2914 = load i64, i64* %_i2900
  %_bop2915 = add i64 %_load2914, 1
  store i64 %_bop2915, i64* %_i2900
  br label %_for_cond2902
_for_exit2904:
  %_load2917 = load i64, i64* %_s2898
  ret i64 %_load2917
}
