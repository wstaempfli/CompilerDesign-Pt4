...
define i64 @getminindex({ i64, [0 x i64] }* %a, i64 %s, i64 %b) {
  ...
  %_load3892 = load i64, i64* %_gep_ptr3891
  %_gep_ptr3891 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_a3889, i32 0, i32 1, i64 %_s3890
...
_for_body3899:
  ...
  %_load3910 = load i64, i64* %_gep_ptr3909
  %_gep_ptr3909 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_a3907, i32 0, i32 1, i64 %_i3908
  %_min3911 = load i64, i64* %_min3893
  %_bop3912 = icmp slt i64 %_load3910, %_min3911
  br i1 %_bop3912, label %_then3904, label %_else3905
_then3904:
  %_a3913 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_a3880
  %_i3914 = load i64, i64* %_i3887
  %_load3916 = load i64, i64* %_gep_ptr3915
  %_gep_ptr3915 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_a3913, i32 0, i32 1, i64 %_i3914
...
_for_body3849:
  ...
  %_call3857 = call i64 @getminindex({ i64, [0 x i64] }* %_a3854, i64 %_i3855, i64 %_s3856)
  store i64 %_call3857, i64* %_mi3844
  %_a3859 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_a3838
  %_i3860 = load i64, i64* %_i3846
  %_load3862 = load i64, i64* %_gep_ptr3861
  %_gep_ptr3861 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_a3859, i32 0, i32 1, i64 %_i3860
  store i64 %_load3862, i64* %_t3842
  %_a3864 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_a3838
  %_mi3865 = load i64, i64* %_mi3844
  %_load3867 = load i64, i64* %_gep_ptr3866
  %_gep_ptr3866 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_a3864, i32 0, i32 1, i64 %_mi3865
...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  store i64 5, i64* %_gep3803
  %_gep3803 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_array3802, i32 0, i32 1, i32 0
  store i64 200, i64* %_gep3805
  %_gep3805 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_array3802, i32 0, i32 1, i32 1
  store i64 1, i64* %_gep3807
  %_gep3807 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_array3802, i32 0, i32 1, i32 2
  store i64 65, i64* %_gep3809
  %_gep3809 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_array3802, i32 0, i32 1, i32 3
  store i64 30, i64* %_gep3811
  %_gep3811 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_array3802, i32 0, i32 1, i32 4
  store i64 99, i64* %_gep3813
  %_gep3813 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_array3802, i32 0, i32 1, i32 5
  store i64 2, i64* %_gep3815
  %_gep3815 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_array3802, i32 0, i32 1, i32 6
  store i64 0, i64* %_gep3817
  %_gep3817 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_array3802, i32 0, i32 1, i32 7
...
_for_body3826:
  ...
  %_load3833 = load i64, i64* %_gep_ptr3832
  %_gep_ptr3832 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_ar3830, i32 0, i32 1, i64 %_i3831
