...
_for_body195:
  ...
  %_201 = getelementptr { i64, [0 x { i64, [0 x i64] }*] }, { i64, [0 x { i64, [0 x i64] }*] }* %_x199, i32 0, i32 1, i64 %_i200
  %_202 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_201
  %_203 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_202, i32 0, i32 1, i32 0
  %_204 = load i64, i64* %_203
  %_ans205 = load i64, i64* %_ans190
  %_bop206 = sub i64 %_204, %_ans205
