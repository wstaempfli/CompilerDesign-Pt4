...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  %_function2843 = call i8* @string_of_array({ i64, [0 x i64] }* %_arr12842)
  store i8* %_function2843, i8** %_str2844
  %_str2846 = load i8*, i8** %_str2844
  %_function2847 = call { i64, [0 x i64] }* @array_of_string(i8* %_str2846)
  store { i64, [0 x i64] }* %_function2847, { i64, [0 x i64] }** %_arr22848
...
_for_body2855:
  ...
  %_gep2862 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_arr22860, i32 0, i32 1, i64 %_i2861
