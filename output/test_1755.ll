...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  %_str2954 = bitcast [11 x i8]* @_str2953 to i8*
  %_funcall2955 = call { i64, [0 x i64] }* @array_of_string(i8* %_str2954)
  store { i64, [0 x i64] }* %_funcall2955, { i64, [0 x i64] }** %_arr2956
...
_for_body2978:
  ...
  %_elem_addr2985 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_arr2983, i32 0, i32 1, i64 %_i2984
  %_read_val2986 = load i64, i64* %_elem_addr2985
  %_bop2987 = add i64 %_sum2982, %_read_val2986
